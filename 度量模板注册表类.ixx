...
public:
    ...
    enum class 枚举_刻度语义 : std::uint8_t {
        未定义 = 0,
        低 = 1,
        中 = 2,
        高 = 3,
...
private:
    ...
    public:
        ...
        {
            return {
                { I64区间{ 0, 3333 }, 枚举_刻度语义::小差异, false },
                { I64区间{ 3334, 6666 }, 枚举_刻度语义::中差异, false },
                { I64区间{ 6667, 10000 }, 枚举_刻度语义::大差异, false },
            };
        }
    };
    ...
    public:
        ...
        {
            return {
                { I64区间{ 0, 3333 }, 枚举_刻度语义::低相似, false },
                { I64区间{ 3334, 6666 }, 枚举_刻度语义::中相似, false },
                { I64区间{ 6667, 10000 }, 枚举_刻度语义::高相似, false },
            };
        }
    };
    ...
    public:
        ...
        {
            return {
                { I64区间{ 0, 3333 }, 枚举_刻度语义::覆盖低, false },
                { I64区间{ 3334, 6666 }, 枚举_刻度语义::覆盖中, false },
                { I64区间{ 6667, 10000 }, 枚举_刻度语义::覆盖高, false },
            };
        }
    };
    ...
    public:
        ...
        {
            return {
                { I64区间{ 0, 0 }, 枚举_刻度语义::齐全, false },
                { I64区间{ 1, 1 }, 枚举_刻度语义::缺A, false },
                { I64区间{ 2, 2 }, 枚举_刻度语义::缺B, false },
                { I64区间{ 3, 3 }, 枚举_刻度语义::都缺, false },
            };
        }
    };
