...
public:
    ...
    语素入口节点类* 查找人类词性入口节点(const std::string& 词值, const std::string& 词性值) const;
    ...
    语素入口节点类* 查找信息入口节点(const std::string& 词值, 枚举_信息入口类型 信息入口类型) const;
    ...
    bool 是语素入口节点(const 语素入口节点类* 入口节点) const noexcept;
    枚举_词性 获取语素入口人类词性(const 语素入口节点类* 入口节点) const;
    枚举_主信息类型 获取语素入口对应基础信息类型(const 语素入口节点类* 入口节点) const;
    枚举_主信息类型 获取语素入口显式对应基础信息类型(const 语素入口节点类* 入口节点) const;
    枚举_信息入口类型 获取语素入口信息入口类型(const 语素入口节点类* 入口节点) const;
    static const 结构_信息入口定义* 读取信息入口定义(枚举_信息入口类型 信息入口类型) noexcept;
    static 枚举_主信息类型 读取信息入口主信息类型(枚举_信息入口类型 信息入口类型) noexcept;
    static 枚举_信息存储树 读取信息入口存储树(枚举_信息入口类型 信息入口类型) noexcept;
    static 枚举_词性 读取信息入口默认人类词性(枚举_信息入口类型 信息入口类型) noexcept;
    static const char* 读取信息入口默认根名(枚举_信息入口类型 信息入口类型) noexcept;
