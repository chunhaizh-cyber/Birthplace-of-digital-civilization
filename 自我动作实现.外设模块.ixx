...
namespace {
    ...
    inline constexpr I64 D455短期材料页观察治理保护毫秒 = 5000;
    inline constexpr I64 外设观察存在同一性最小证据帧数 = 2;
    inline constexpr I64 观察存在事实提交状态_未提交 = 0;
    inline constexpr I64 体素观察证据消费状态_未生成 = 0;
    inline constexpr I64 体素观察证据消费状态_待加工 = 1;
    inline constexpr I64 体素观察证据消费状态_粗体素已写入 = 2;
    inline constexpr I64 体素观察证据消费状态_版本变化挂起 = 3;
    inline constexpr I64 体素观察证据消费状态_拒绝 = 9;
    inline constexpr I64 体素加工候选结果包状态_未生成 = 0;
    inline constexpr I64 体素加工候选结果包状态_版本匹配待裁决 = 1;
    inline constexpr I64 体素加工候选结果包状态_版本变化挂起 = 2;
    inline constexpr I64 体素加工候选结果包状态_条件不足 = 3;
    inline constexpr I64 体素加工候选结果包状态_父体素已写入 = 4;
    inline constexpr I64 体素颜色事实状态_未生成 = 0;
    inline constexpr I64 体素颜色事实状态_已写入 = 1;
    inline constexpr I64 体素颜色事实状态_缺候选包 = 2;
    inline constexpr I64 体素颜色事实状态_候选统计无效 = 3;
    inline constexpr I64 体素颜色事实状态_版本不匹配 = 4;
    inline constexpr I64 体素颜色事实状态_缺子候选映射 = 5;
    inline constexpr I64 体素子候选映射状态_未生成 = 0;
    inline constexpr I64 体素子候选映射状态_已映射 = 1;
    inline constexpr I64 体素子候选映射状态_缺候选包 = 2;
    inline constexpr I64 体素子候选映射状态_无可映射候选 = 3;
    inline constexpr I64 体素子候选映射状态_多可映射候选 = 4;
    inline constexpr I64 体素子候选映射状态_版本不匹配 = 5;
    inline constexpr I64 体素子候选映射状态_输入非法 = 9;
    inline constexpr I64 父体素候选版本闸门状态_未检查 = 0;
    inline constexpr I64 父体素候选版本闸门状态_可裁决 = 1;
    inline constexpr I64 父体素候选版本闸门状态_缺父存在 = 2;
    inline constexpr I64 父体素候选版本闸门状态_缺基准版本 = 3;
    inline constexpr I64 父体素候选版本闸门状态_当前版本非法 = 4;
    inline constexpr I64 父体素候选版本闸门状态_版本变化挂起 = 5;
    inline constexpr I64 体素融合输入组状态_未生成 = 0;
    inline constexpr I64 体素融合输入组状态_只读摘要已生成 = 1;
    inline constexpr I64 体素融合输入组状态_阻断 = 2;
    inline constexpr I64 体素融合输入阻断_缺目标存在 = 1;
    inline constexpr I64 体素融合输入阻断_同一性未收束 = 2;
    inline constexpr I64 体素融合输入阻断_缺观察体素证据 = 4;
    inline constexpr I64 体素融合输入阻断_缺稳定体素模型 = 8;
    inline constexpr I64 体素融合输入阻断_缺基准版本 = 16;
    inline constexpr I64 体素融合输入阻断_基准版本失配 = 32;
    inline constexpr I64 体素融合输入阻断_缺候选结果包 = 64;
    inline constexpr I64 体素融合输入阻断_缺局部子体素候选 = 128;
    inline constexpr I64 体素融合待处理状态_未生成 = 0;
    inline constexpr I64 体素融合待处理状态_已生成 = 1;
    inline constexpr I64 体素融合待处理状态_同键已存在 = 2;
    inline constexpr I64 体素融合待处理状态_挂起 = 3;
    inline constexpr I64 体素融合待处理挂起_输入组阻断 = 1;
    inline constexpr I64 体素融合待处理挂起_缺幂等材料 = 2;
    inline constexpr I64 体素融合待处理挂起_基准版本失配 = 4;
    inline constexpr I64 体素融合子轮廓候选状态_未生成 = 0;
    inline constexpr I64 体素融合子轮廓候选状态_已收束 = 1;
    inline constexpr I64 体素融合子轮廓候选状态_阻断 = 2;
    inline constexpr I64 体素融合子轮廓候选阻断_缺待处理材料 = 1;
    inline constexpr I64 体素融合子轮廓候选阻断_缺候选结果包 = 2;
    inline constexpr I64 体素融合子轮廓候选阻断_父候选触碰外边界 = 4;
    inline constexpr I64 体素融合子轮廓候选阻断_无融合点 = 8;
    inline constexpr I64 体素融合子轮廓候选阻断_子候选质量不足 = 16;
    inline constexpr I64 体素融合子轮廓候选阻断_缺深度支撑 = 32;
    inline constexpr I64 体素融合主模型候选状态_未生成 = 0;
    inline constexpr I64 体素融合主模型候选状态_已生成 = 1;
    inline constexpr I64 体素融合主模型候选状态_阻断 = 2;
    inline constexpr I64 体素融合主模型候选阻断_缺待处理材料 = 1;
    inline constexpr I64 体素融合主模型候选阻断_子轮廓候选阻断 = 2;
    inline constexpr I64 体素融合主模型候选阻断_基准版本失配 = 4;
    inline constexpr I64 体素融合主模型候选阻断_缺融合点 = 8;
    inline constexpr I64 体素融合主模型候选阻断_越界 = 16;
    inline constexpr I64 体素融合主模型候选阻断_冲突 = 32;
    inline constexpr I64 体素融合主模型候选阻断_缺可生成子体素候选 = 64;
    ...
    inline constexpr I64 先验版本可接受状态_未检查 = 0;
    inline constexpr I64 先验版本可接受状态_可接受 = 1;
    inline constexpr I64 先验版本可接受状态_条件不足 = 2;
    inline constexpr I64 先验版本可接受状态_来源材料过期 = 3;
    inline constexpr I64 先验版本可接受状态_视觉证据不足 = 4;
    inline constexpr I64 先验版本闸门缺口_无 = 0;
    inline constexpr I64 先验版本闸门缺口_缺观察域结果包 = 1;
    inline constexpr I64 先验版本闸门缺口_缺先验版本 = 2;
    inline constexpr I64 先验版本闸门缺口_缺坐标系版本 = 4;
    inline constexpr I64 先验版本闸门缺口_先验不可用 = 8;
    inline constexpr I64 先验版本闸门缺口_来源材料缺时间 = 16;
    inline constexpr I64 先验版本闸门缺口_来源材料过期 = 32;
    inline constexpr I64 先验版本闸门缺口_来源坐标系不一致 = 64;
    inline constexpr I64 先验版本闸门缺口_视觉信息缺口 = 128;
    inline constexpr I64 先验版本闸门缺口_视觉证据不足 = 256;
    inline constexpr I64 先验版本闸门缺口_自由空间冲突 = 512;
    inline constexpr I64 映射缺口原因_识别正式结果不可读 = 1;
    inline constexpr I64 映射缺口原因_计数不可读 = 2;
    inline constexpr I64 映射缺口原因_提交确认链不可读 = 4;
    inline constexpr I64 映射缺口原因_未稳定对应单位 = 8;
    inline constexpr I64 映射缺口原因_CE多重对应冲突 = 16;
    inline constexpr I64 映射缺口原因_证据不足 = 32;
    inline constexpr I64 映射缺口原因_来源材料不可交付 = 64;
    inline constexpr I64 映射缺口原因_视觉先验版本闸门不通过 = 128;
    inline constexpr I64 视觉先验匹配状态_未读取 = 0;
    inline constexpr I64 视觉先验匹配状态_已匹配 = 1;
    inline constexpr I64 视觉先验匹配状态_无匹配 = 2;
    inline constexpr I64 视觉先验匹配状态_冲突 = 3;
    inline constexpr I64 视觉先验匹配状态_证据不足 = 4;
    ...
    inline constexpr I64 观察内部治理记录状态_未生成 = 0;
    inline constexpr I64 观察内部治理记录状态_已生成 = 1;
    inline constexpr I64 观察内部治理记录状态_条件不足 = 2;
    ...
    inline constexpr I64 跟踪先验预计范围状态_未读取 = 0;
    inline constexpr I64 跟踪先验预计范围状态_已建立 = 1;
    inline constexpr I64 跟踪先验预计范围状态_条件不足 = 2;
    inline constexpr I64 跟踪丢失解释状态_未解释 = 0;
    inline constexpr I64 跟踪丢失解释状态_无丢失 = 1;
    inline constexpr I64 跟踪丢失解释状态_遮挡 = 2;
    inline constexpr I64 跟踪丢失解释状态_自由空间冲突 = 3;
    inline constexpr I64 跟踪丢失解释状态_深度缺失 = 4;
    inline constexpr I64 跟踪丢失解释状态_证据不足 = 5;
    inline constexpr I64 跟踪丢失解释状态_视野外 = 6;
    ...
    // 功能：记录观察内部治理被动动作的结构化结果。
    inline const 语素入口节点类* 类型_观察内部治理记录() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("观察内部治理记录", 枚举_信息入口类型::存在概念入口);
        return s_词;
    }
    ...
    // 功能：按函数名执行对应处理。
    inline const 语素入口节点类* 特征_相机水平视野角毫度() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("相机水平视野角毫度", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：按函数名执行对应处理。
    inline const 语素入口节点类* 特征_相机垂直视野角毫度() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("相机垂直视野角毫度", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：按函数名执行对应处理。
    inline const 语素入口节点类* 特征_相机视野参数状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("相机视野参数状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }
    ...
    // 功能：返回已确认观察存在承载稳定三维体素链的特征类型。
    inline const 语素入口节点类* 特征_三维体素模型() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("三维体素模型", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回已确认观察存在最新体素观察证据的结构化 ID 特征类型。
    inline const 语素入口节点类* 特征_体素观察证据ID() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素观察证据ID", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回已确认观察存在体素观察证据消费状态特征类型。
    inline const 语素入口节点类* 特征_体素观察证据消费状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素观察证据消费状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回体素观察证据对应来源报告 ID 特征类型。
    inline const 语素入口节点类* 特征_体素观察证据来源报告ID() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素观察证据来源报告ID", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回体素观察证据对应来源像素簇 ID 特征类型。
    inline const 语素入口节点类* 特征_体素观察证据来源簇ID() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素观察证据来源簇ID", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回已确认观察存在当前体素模型版本特征类型。
    inline const 语素入口节点类* 特征_体素模型版本() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素模型版本", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回体素加工读取父体素快照时的基准版本特征类型。
    inline const 语素入口节点类* 特征_体素加工基准体素版本() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素加工基准体素版本", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回体素加工候选结果包当前状态特征类型。
    inline const 语素入口节点类* 特征_体素加工候选结果包状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素加工候选结果包状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合输入组只读摘要状态特征类型。
    inline const 语素入口节点类* 特征_体素融合输入组状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合输入组状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合输入组阻断原因掩码特征类型。
    inline const 语素入口节点类* 特征_体素融合输入阻断原因掩码() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合输入阻断原因掩码", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合输入组来源观察证据 ID 特征类型。
    inline const 语素入口节点类* 特征_体素融合输入观察证据ID() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合输入观察证据ID", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合输入组基准体素版本特征类型。
    inline const 语素入口节点类* 特征_体素融合输入基准体素版本() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合输入基准体素版本", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合输入组当前稳定体素版本特征类型。
    inline const 语素入口节点类* 特征_体素融合输入当前体素版本() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合输入当前体素版本", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合输入组候选结果包数量特征类型。
    inline const 语素入口节点类* 特征_体素融合输入候选结果包数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合输入候选结果包数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合输入组局部子体素候选数量特征类型。
    inline const 语素入口节点类* 特征_体素融合输入局部子体素候选数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合输入局部子体素候选数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合输入组有深度支撑子候选数量特征类型。
    inline const 语素入口节点类* 特征_体素融合输入有深度支撑子候选数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合输入有深度支撑子候选数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合待处理材料状态特征类型。
    inline const 语素入口节点类* 特征_体素融合待处理状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合待处理状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合待处理材料幂等键特征类型。
    inline const 语素入口节点类* 特征_体素融合待处理幂等键() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合待处理幂等键", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合待处理挂起原因掩码特征类型。
    inline const 语素入口节点类* 特征_体素融合待处理挂起原因掩码() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合待处理挂起原因掩码", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合待处理同键重复命中次数特征类型。
    inline const 语素入口节点类* 特征_体素融合待处理重复命中次数() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合待处理重复命中次数", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合子轮廓候选检查状态特征类型。
    inline const 语素入口节点类* 特征_体素融合子轮廓候选状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合子轮廓候选状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合子轮廓候选阻断原因掩码特征类型。
    inline const 语素入口节点类* 特征_体素融合子轮廓候选阻断原因掩码() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合子轮廓候选阻断原因掩码", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合子轮廓候选数量特征类型。
    inline const 语素入口节点类* 特征_体素融合子轮廓候选数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合子轮廓候选数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合可生成局部子体素候选数量特征类型。
    inline const 语素入口节点类* 特征_体素融合可生成局部子体素候选数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合可生成局部子体素候选数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合父候选触碰外边界数量特征类型。
    inline const 语素入口节点类* 特征_体素融合父候选触碰外边界数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合父候选触碰外边界数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合无融合点候选包数量特征类型。
    inline const 语素入口节点类* 特征_体素融合无融合点候选包数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合无融合点候选包数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合主模型候选状态特征类型。
    inline const 语素入口节点类* 特征_体素融合主模型候选状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合主模型候选状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合主模型候选阻断原因掩码特征类型。
    inline const 语素入口节点类* 特征_体素融合主模型候选阻断原因掩码() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合主模型候选阻断原因掩码", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合主模型候选来源观察证据 ID 特征类型。
    inline const 语素入口节点类* 特征_体素融合主模型候选来源观察证据ID() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合主模型候选来源观察证据ID", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合主模型候选基准体素版本特征类型。
    inline const 语素入口节点类* 特征_体素融合主模型候选基准体素版本() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合主模型候选基准体素版本", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合主模型候选融合点数量特征类型。
    inline const 语素入口节点类* 特征_体素融合主模型候选融合点数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合主模型候选融合点数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合主模型候选冲突数量特征类型。
    inline const 语素入口节点类* 特征_体素融合主模型候选冲突数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合主模型候选冲突数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合主模型候选越界数量特征类型。
    inline const 语素入口节点类* 特征_体素融合主模型候选越界数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合主模型候选越界数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回 P12 体素融合主模型更新候选数量特征类型。
    inline const 语素入口节点类* 特征_体素融合主模型更新候选数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素融合主模型更新候选数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回父存在体素基础颜色 RGBA 事实特征类型。
    inline const 语素入口节点类* 特征_体素父基础颜色RGBA() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素父基础颜色RGBA", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回父存在体素基础颜色统计像素数量特征类型。
    inline const 语素入口节点类* 特征_体素父基础颜色像素数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素父基础颜色像素数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回父存在体素基础颜色事实写入状态特征类型。
    inline const 语素入口节点类* 特征_体素父基础颜色事实状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素父基础颜色事实状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回子存在体素平均颜色 RGBA 事实特征类型。
    inline const 语素入口节点类* 特征_体素子平均颜色RGBA() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素子平均颜色RGBA", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回子存在体素平均颜色统计像素数量特征类型。
    inline const 语素入口节点类* 特征_体素子平均颜色像素数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素子平均颜色像素数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回子存在体素平均颜色事实写入状态特征类型。
    inline const 语素入口节点类* 特征_体素子平均颜色事实状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素子平均颜色事实状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回体素颜色事实来源观察证据 ID 特征类型。
    inline const 语素入口节点类* 特征_体素颜色来源观察证据ID() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素颜色来源观察证据ID", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回体素颜色事实来源基准体素版本特征类型。
    inline const 语素入口节点类* 特征_体素颜色来源基准体素版本() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素颜色来源基准体素版本", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回子存在体素颜色映射来源的子轮廓候选 ID 特征类型。
    inline const 语素入口节点类* 特征_体素子候选ID() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素子候选ID", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回子存在体素颜色映射来源的局部子体素候选 ID 特征类型。
    inline const 语素入口节点类* 特征_体素局部子体素候选ID() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素局部子体素候选ID", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：返回子轮廓候选到内部世界子存在的映射状态特征类型。
    inline const 语素入口节点类* 特征_体素子候选映射状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("体素子候选映射状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }
    ...
    // 功能：记录提交入口读取到的 SceneVoxelPrior 运行期版本。
    inline const 语素入口节点类* 特征_场景体素先验版本() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("场景体素先验版本", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录提交入口读取到的 SceneVoxelPrior 坐标系版本。
    inline const 语素入口节点类* 特征_场景体素先验坐标系版本() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("场景体素先验坐标系版本", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录观察域结果包中的场景体素先验可用状态。
    inline const 语素入口节点类* 特征_场景体素先验可用状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("场景体素先验可用状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录提交入口读取到的视觉融合信息缺口数量。
    inline const 语素入口节点类* 特征_视觉信息缺口数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视觉信息缺口数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录提交入口读取到的视觉证据不足数量。
    inline const 语素入口节点类* 特征_视觉证据不足数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视觉证据不足数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录 6145 只读消费视觉先验后的匹配状态。
    inline const 语素入口节点类* 特征_视觉先验匹配状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视觉先验匹配状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录视觉融合先验匹配候选数量。
    inline const 语素入口节点类* 特征_视觉先验匹配数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视觉先验匹配数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录视觉融合先验匹配综合评分。
    inline const 语素入口节点类* 特征_视觉先验匹配评分() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视觉先验匹配评分", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录视觉融合深度一致评分。
    inline const 语素入口节点类* 特征_视觉深度一致评分() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视觉深度一致评分", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录视觉融合自由空间冲突候选数量。
    inline const 语素入口节点类* 特征_视觉自由空间冲突候选数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视觉自由空间冲突候选数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录视觉融合遮挡候选数量。
    inline const 语素入口节点类* 特征_视觉遮挡候选数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视觉遮挡候选数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录视觉融合深度缺失数量。
    inline const 语素入口节点类* 特征_视觉深度缺失数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视觉深度缺失数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录视觉链路给出的视野外证据数量。
    inline const 语素入口节点类* 特征_视野外证据数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("视野外证据数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录 6147 只读消费视觉先验后的预计范围状态。
    inline const 语素入口节点类* 特征_跟踪先验预计范围状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("跟踪先验预计范围状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录 6147 只读消费视觉先验后的丢失解释状态。
    inline const 语素入口节点类* 特征_跟踪丢失解释状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("跟踪丢失解释状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录提交入口对观察域结果包先验版本闸门的判定状态。
    inline const 语素入口节点类* 特征_先验版本可接受状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("先验版本可接受状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录提交入口先验版本闸门的结构化缺口原因。
    inline const 语素入口节点类* 特征_先验版本闸门缺口原因掩码() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("先验版本闸门缺口原因掩码", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }
    ...
    // 功能：记录观察内部治理记录是否已经形成。
    inline const 语素入口节点类* 特征_观察内部治理记录状态() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("观察内部治理记录状态", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录本轮观察创建新的已确认观察存在数量。
    inline const 语素入口节点类* 特征_观察新建存在数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("观察新建存在数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录本轮观察更新已有观察存在数量。
    inline const 语素入口节点类* 特征_观察更新已有存在数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("观察更新已有存在数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录本轮观察写入或更新的结构化特征数量。
    inline const 语素入口节点类* 特征_观察写入特征数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("观察写入特征数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录本轮观察治理处理的候选项数量。
    inline const 语素入口节点类* 特征_观察治理处理项数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("观察治理处理项数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }

    // 功能：记录本轮观察治理写入失败数量。
    inline const 语素入口节点类* 特征_观察治理写入失败数量() noexcept
    {
        static const 语素入口节点类* s_词 = 语素集.添加信息入口词("观察治理写入失败数量", 枚举_信息入口类型::特征模板入口);
        return s_词;
    }
    ...
    // 功能：登记 P11 共享关联判断结果的既有特征族，供四方法只读消费候选、评分、计数和缺口材料。
    inline bool 登记P11共享关联判断结果特征(
        方法类::节点类* 方法首节点,
        基础信息节点类* 宿主,
        时间戳 now,
        bool 声明为条件) noexcept
    {
        bool ok = true;
        auto 登记 = [&](const 语素入口节点类* 特征类型) {
            if (!特征类型) return;
            if (声明为条件 && 方法首节点) {
                ok = 方法类::声明条件特征(方法首节点, 特征类型, false, now) && ok;
            }
            if (宿主) {
                ok = 世界树.取或创建子特征_按类型(宿主, 特征类型) && ok;
            }
        };

        登记(特征_外设观察存在候选确认状态());
        登记(特征_外设观察存在候选确认方案取得状态());
        登记(特征_外设观察存在候选确认新建数量());
        登记(特征_外设观察存在候选确认合并数量());
        登记(特征_外设观察存在候选确认冲突数量());
        登记(特征_外设观察存在候选确认证据不足数量());
        登记(特征_外设观察存在候选确认可提交数量());
        登记(特征_外设观察存在_自我存在同一性状态());
        登记(特征_外设观察存在_自我存在同一性评分());
        登记(特征_外设观察存在同一性证据帧数());
        登记(特征_外设观察存在自我归属状态());
        登记(特征_视觉先验匹配状态());
        登记(特征_视觉先验匹配数量());
        ...
        登记(特征_视觉深度缺失数量());
        登记(特征_视觉证据不足数量());
        登记(特征_当前观察范围有效可观测单位数量());
        登记(特征_已稳定对应存在可观测单位数量());
        登记(特征_未稳定对应存在可观测单位数量());
        登记(特征_多重对应冲突可观测单位数量());
        登记(特征_稳定对应存在数量());
        登记(特征_映射稳定性状态());
        登记(特征_映射缺口原因掩码());
        ...
        登记(特征_体素融合输入当前体素版本());
        登记(特征_体素融合输入候选结果包数量());
        登记(特征_体素融合输入局部子体素候选数量());
        登记(特征_体素融合输入有深度支撑子候选数量());
        登记(特征_体素融合待处理状态());
        登记(特征_体素融合待处理幂等键());
        登记(特征_体素融合待处理挂起原因掩码());
        登记(特征_体素融合待处理重复命中次数());
        登记(特征_体素融合子轮廓候选状态());
        登记(特征_体素融合子轮廓候选阻断原因掩码());
        登记(特征_体素融合子轮廓候选数量());
        登记(特征_体素融合可生成局部子体素候选数量());
        登记(特征_体素融合父候选触碰外边界数量());
        登记(特征_体素融合无融合点候选包数量());
        登记(特征_体素融合主模型候选状态());
        登记(特征_体素融合主模型候选阻断原因掩码());
        登记(特征_体素融合主模型候选来源观察证据ID());
        登记(特征_体素融合主模型候选基准体素版本());
        登记(特征_体素融合主模型候选融合点数量());
        登记(特征_体素融合主模型候选冲突数量());
        登记(特征_体素融合主模型候选越界数量());
        登记(特征_体素融合主模型更新候选数量());
        return ok;
    ...
    // 功能：把毫米空间范围换算为体素维度，至少保留 1 个占据体素。
    inline std::uint32_t 观察簇空间范围体素维度(
        I64 最小值,
        I64 最大值,
        std::uint32_t 最小体素边长_mm) noexcept
    {
        if (最小体素边长_mm == 0 || 最大值 < 最小值) {
            return 0;
        }
        const auto 跨度_mm = static_cast<long double>(最大值) - static_cast<long double>(最小值);
        if (!std::isfinite(跨度_mm) || 跨度_mm < 0.0L) {
            return 0;
        }
        const auto 维度 = std::floor(跨度_mm / static_cast<long double>(最小体素边长_mm)) + 1.0L;
        if (维度 < 1.0L || 维度 > static_cast<long double>((std::numeric_limits<std::uint32_t>::max)())) {
            return 0;
        }
        return static_cast<std::uint32_t>(维度);
    }

    // 功能：把来源报告和像素簇压成体素观察证据 ID，作为同一观察证据的幂等键。
    inline I64 构造体素观察证据ID(
        I64 来源报告ID,
        const 结构_外设观察像素簇摘要& 簇) noexcept
    {
        if (来源报告ID <= 0) {
        ...
        const I64 簇ID = 簇.外设内部簇ID > 0
            ? 簇.外设内部簇ID
            : 簇.来源空间候选ID;
        if (簇ID <= 0 || 来源报告ID > 9000000000000LL || 簇ID > 999999LL) {
            return 0;
        }
        return 来源报告ID * 1000000LL + 簇ID;
    }

    // 功能：判断同一体素观察证据是否已经进入终止消费状态，避免旧当前值和写回路径重复触发。
    inline bool 体素观察证据已消费(
        基础信息节点类* 节点,
        I64 观察证据ID) noexcept
    {
        if (!节点 || 观察证据ID <= 0) {
        ...
        I64 已有证据ID = 0;
        I64 已有消费状态 = 0;
        return 读取基础节点I64(节点, 特征_体素观察证据ID(), 已有证据ID)
            && 已有证据ID == 观察证据ID
            && 读取基础节点I64(节点, 特征_体素观察证据消费状态(), 已有消费状态)
            && 已有消费状态 >= 体素观察证据消费状态_粗体素已写入;
    }

    // 功能：判断同一体素观察证据是否已进入待处理或终止状态，避免同源轮廓组重复触发 worker。
    inline bool 体素观察证据已登记或消费(
        基础信息节点类* 节点,
        I64 观察证据ID) noexcept
    {
        if (!节点 || 观察证据ID <= 0) {
        ...
        return 读取基础节点I64(节点, 特征_体素观察证据ID(), 已有证据ID)
            && 已有证据ID == 观察证据ID
            && 读取基础节点I64(节点, 特征_体素观察证据消费状态(), 已有消费状态)
            && 已有消费状态 != 体素观察证据消费状态_未生成
            && 已有消费状态 != 体素观察证据消费状态_拒绝;
    }

    struct 结构_父体素候选版本闸门结果 {
        I64 闸门状态 = 父体素候选版本闸门状态_未检查;
        I64 基准体素版本 = 0;
        I64 当前体素版本 = 0;
    };

    // 功能：判断父体素候选是否允许进入正式裁决。
    inline bool 父体素候选版本闸门可裁决(const 结构_父体素候选版本闸门结果& 结果) noexcept
    {
        return 结果.闸门状态 == 父体素候选版本闸门状态_可裁决;
    }

    // 功能：判断父体素候选是否因版本变化只能挂起。
    inline bool 父体素候选版本闸门版本变化挂起(const 结构_父体素候选版本闸门结果& 结果) noexcept
    {
        return 结果.闸门状态 == 父体素候选版本闸门状态_版本变化挂起;
    }

    // 功能：判断体素版本值是否可作为正式版本闸门输入。
    inline bool 体素版本值有效(I64 版本) noexcept
    {
        return 版本 >= 0 && 版本 != (std::numeric_limits<I64>::max)();
    }

    // 功能：检查父体素候选基准版本和当前父体素版本是否匹配。
    inline 结构_父体素候选版本闸门结果 检查父体素候选版本闸门(
        基础信息节点类* 父存在节点,
        I64 基准体素版本) noexcept
    {
        结构_父体素候选版本闸门结果 结果{};
        结果.基准体素版本 = 基准体素版本;
        if (!父存在节点) {
            结果.闸门状态 = 父体素候选版本闸门状态_缺父存在;
            return 结果;
        }
        if (!体素版本值有效(基准体素版本)) {
            结果.闸门状态 = 父体素候选版本闸门状态_缺基准版本;
            return 结果;
        }

        I64 当前体素版本 = 0;
        (void)读取基础节点I64(父存在节点, 特征_体素模型版本(), 当前体素版本);
        结果.当前体素版本 = 当前体素版本;
        if (!体素版本值有效(当前体素版本)) {
            结果.闸门状态 = 父体素候选版本闸门状态_当前版本非法;
            return 结果;
        }

        结果.闸门状态 = 当前体素版本 == 基准体素版本
            ? 父体素候选版本闸门状态_可裁决
            : 父体素候选版本闸门状态_版本变化挂起;
        return 结果;
    }

    // 功能：判断平均颜色统计是否足够写入正式颜色事实。
    inline bool 体素颜色统计可写(
        const 视觉观察融合模块::结构_体素颜色平均统计& 统计) noexcept
    {
        return 统计.有效
            && 统计.像素数量 > 0
            && 统计.平均颜色RGBA != 0;
    ...
    // 功能：把 RGBA32 颜色值转为 I64 特征值。
    inline I64 体素颜色RGBA转I64(std::uint32_t 颜色RGBA) noexcept
    {
        return static_cast<I64>(static_cast<std::uint64_t>(颜色RGBA));
    }

    // 功能：创建体素加工线程使用的正立方体占据位块。
    inline VecIU64 创建体素加工正立方体占据位块(
        std::uint32_t 包围盒边长,
        std::uint64_t 最大体素数)
    {
        const auto 总数 = 三维体素总数(包围盒边长);
        if (包围盒边长 < 3 || 总数 == 0 || 总数 > 最大体素数) {
            return {};
        }
        const auto 块数 = (总数 + 63ull) / 64ull;
        if (块数 > static_cast<std::uint64_t>((std::numeric_limits<std::size_t>::max)())) {
            return {};
        }
    ...
    // 功能：把来源轮廓像素坐标映射到正立方体包围盒 1..N-2 有效区。
    inline std::uint32_t 映射体素加工有效区坐标(
        std::uint32_t 偏移,
        std::uint32_t 跨度,
        std::uint32_t 包围盒边长) noexcept
    {
        if (包围盒边长 < 3) {
            return 0;
        }
    ...
    // 功能：读取体素加工轮廓视角的像素数量。
    inline std::size_t 读取体素加工轮廓视角像素数量(
        const 结构_三维体素轮廓图视角& 视角) noexcept
    {
        if (视角.宽度 == 0 || 视角.高度 == 0) {
            return 0;
        }
    ...
    // 功能：由合法轮廓视角构造体素加工父体素候选快照。
    inline VecIU64 构造体素加工父候选快照_由轮廓视角(
        const 结构_三维体素轮廓图视角& 视角,
        std::uint32_t 包围盒边长,
        std::uint64_t 最大体素数)
    {
        const auto 像素数 = 读取体素加工轮廓视角像素数量(视角);
        if (像素数 == 0
            || 视角.轮廓掩码.size() < 像素数
            || 视角.深度_mm.size() < 像素数
            || 视角.空间点_mm.size() < 像素数) {
        ...
        I64 最大深度 = 0;
        bool 有有效点 = false;
        for (std::size_t 索引 = 0; 索引 < 像素数; ++索引) {
            if (视角.轮廓掩码[索引] == 0
                || 视角.深度_mm[索引] <= 0
                || 视角.空间点_mm[索引].z <= 0) {
                continue;
            }
            最小深度 = std::min<I64>(最小深度, 视角.深度_mm[索引]);
            最大深度 = std::max<I64>(最大深度, 视角.深度_mm[索引]);
            有有效点 = true;
        }
        if (!有有效点) {
            return {};
        ...
        auto 占据位块 = 创建体素加工正立方体占据位块(包围盒边长, 最大体素数);
        if (占据位块.empty()) {
            return {};
        }

        const auto 宽 = static_cast<std::size_t>(视角.宽度);
        for (std::size_t 索引 = 0; 索引 < 像素数; ++索引) {
            if (视角.轮廓掩码[索引] == 0
                || 视角.深度_mm[索引] <= 0
                || 视角.空间点_mm[索引].z <= 0) {
            ...
            const auto 像素X = static_cast<std::uint32_t>(索引 % 宽);
            const auto 像素Y = static_cast<std::uint32_t>(索引 / 宽);
            const auto x = 映射体素加工有效区坐标(像素X, 视角.宽度, 包围盒边长);
            const auto y = 映射体素加工有效区坐标(像素Y, 视角.高度, 包围盒边长);
            std::uint32_t z = 1;
            if (最大深度 > 最小深度 && 包围盒边长 > 3) {
                const auto 有效格数 = 包围盒边长 - 2;
                const auto 比例 = static_cast<double>(视角.深度_mm[索引] - 最小深度)
                    / static_cast<double>(最大深度 - 最小深度);
                const auto 映射 = static_cast<std::uint32_t>(
                    std::llround(std::max(0.0, std::min(1.0, 比例)) * (有效格数 - 1)));
                z = 1 + std::min<std::uint32_t>(映射, 有效格数 - 1);
            }
            (void)设置体素加工正立方体占据位(占据位块, 包围盒边长, x, y, z);
        }
        return 占据位块;
    }

    // 功能：把当前父三维体素模型重采样为体素加工正立方体快照。
    inline VecIU64 读取父三维体素模型正立方体快照(
        特征节点类* 体素特征,
        std::uint32_t 包围盒边长,
        std::uint64_t 最大体素数)
    {
        ...
        VecU句柄 根句柄{};
        if (!世界树.特征().读取三维体素特征值(体素特征, 根句柄)) {
            return {};
        }
        auto* 根节点 = 世界树.值池().取节点(根句柄);
        if (!根节点) {
            return {};
        }
        结构_三维体素链节点信息 根信息{};
        ...
        auto 输出 = 创建体素加工正立方体占据位块(包围盒边长, 最大体素数);
        if (输出.empty()) {
            return {};
        }
        auto 映射到根坐标 = [&](std::uint32_t 坐标) noexcept -> std::uint32_t {
            const auto 映射 = (static_cast<std::uint64_t>(坐标) * 根信息.边长) / 包围盒边长;
            return static_cast<std::uint32_t>(std::min<std::uint64_t>(
                映射,
                static_cast<std::uint64_t>(根信息.边长 - 1)));
        };

        for (std::uint32_t z = 0; z < 包围盒边长; ++z) {
            for (std::uint32_t y = 0; y < 包围盒边长; ++y) {
                for (std::uint32_t x = 0; x < 包围盒边长; ++x) {
                    const auto 查询 = 特征类::查询三维体素二分层链(
                        世界树.值池(),
                        根句柄,
                        映射到根坐标(x),
                        映射到根坐标(y),
                        映射到根坐标(z),
                        根信息.最大层级);
                    if (查询.命中 && 查询.节点.状态 != 枚举_三维体素链节点状态::空) {
                        (void)设置体素加工正立方体占据位(输出, 包围盒边长, x, y, z);
                    }
                }
            }
        }
    ...
    // 功能：把新增观察体素证据提交给体素加工线程，只生成运行期候选结果包。
    inline bool 提交观察体素加工任务_由观察簇(
        存在节点类* 观察存在,
        特征节点类* 体素特征,
        ...
        时间戳 now)
    {
        auto 记录提交诊断 = [&](const char* 阶段,
            const std::string& 原因,
            bool 成功,
            std::uint32_t 包围盒边长,
            std::size_t 父候选块数) {
            const auto 摘要 = 视觉观察融合模块::读取体素加工工作线程摘要();
            std::ostringstream 输出;
            输出 << "观察体素加工任务提交诊断"
                << " | 阶段=" << (阶段 ? 阶段 : "")
                << " | 成功=" << (成功 ? 1 : 0)
                << " | 原因=" << 原因
                << " | 父存在=" << (观察存在 ? 观察存在->获取主键() : std::string("空"))
                << " | 观察证据ID=" << 观察证据ID
                << " | 基准体素版本=" << 基准体素版本
                << " | 簇ID=" << 簇.外设内部簇ID
                << " | 来源空间候选ID=" << 簇.来源空间候选ID
                ...
                << " | 空间坐标有效率=" << 簇.空间坐标有效率
                << " | 深度有效率=" << 簇.深度有效率
                << " | 局部图=" << 簇.局部图宽度 << "x" << 簇.局部图高度
                << " | 包围盒边长=" <<包围盒边长
                << " | 父候选块数=" << 父候选块数
                << " | worker已启动=" << (摘要.已启动 ? 1 : 0)
                << " | worker队列=" << 摘要.任务队列长度
                << " | worker候选包=" << 摘要.候选结果包数量
                << " | worker已接收=" << 摘要.已接收任务数量
                << " | worker已处理=" << 摘要.已处理任务数量
                << " | 只产候选不写事实=1";
            项目运行日志(输出.str());
        };

        if (!观察存在 || 观察证据ID <= 0 || !体素版本值有效(基准体素版本)) {
            记录提交诊断("入口检查", "观察存在空或证据ID/基准版本非法", false, 0, 0);
            return false;
        }
        auto 视角读取 = 读取D455簇三维体素轮廓视角(簇);
        if (!视角读取.成功) {
            记录提交诊断("读取轮廓视角", 视角读取.失败原因, false, 0, 0);
            return false;
        }
        const auto 规格 = 场景体素模块::计算正立方体体素包围盒规格_按来源分辨率(
            视角读取.视角.宽度,
            视角读取.视角.高度);
        if (!规格.有效) {
            记录提交诊断("计算包围盒", "来源分辨率无法形成正立方体包围盒", false, 0, 0);
            return false;
        }

        auto 父候选快照 = 构造体素加工父候选快照_由轮廓视角(
            视角读取.视角,
            规格.包围盒边长,
            最大体素数);
        if (父候选快照.empty()) {
            记录提交诊断("构造父候选", "父体素候选快照为空", false, 规格.包围盒边长, 0);
            return false;
        }
        const auto 父候选块数 = 父候选快照.size();

        视觉观察融合模块::结构_体素加工任务 任务{};
        任务.任务ID = 观察证据ID;
        任务.父存在 = 可解析引用<存在节点类>{观察存在};
        任务.输入观察证据ID = 观察证据ID;
        任务.基准体素版本 = 基准体素版本;
        任务.包围盒边长 = 规格.包围盒边长;
        任务.最大扫描体素数 = 最大体素数;
        任务.现有父体素占据快照 = 读取父三维体素模型正立方体快照(
            体素特征,
            规格.包围盒边长,
            最大体素数);
        任务.父体素占据候选快照 = std::move(父候选快照);
        任务.彩色轮廓视角 = std::move(视角读取.视角);
        任务.深度轮廓视角 = 任务.彩色轮廓视角;
        任务.提交时间 = now != 0 ? now : 结构体_时间戳::当前_微秒();

        if (!视觉观察融合模块::启动体素加工工作线程()) {
            记录提交诊断("启动worker", "体素加工工作线程启动失败", false, 规格.包围盒边长, 父候选块数);
            return false;
        }
        const bool 提交成功 = 视觉观察融合模块::提交体素加工任务(std::move(任务));
        记录提交诊断(
            "提交任务",
            提交成功 ? "已进入体素加工队列" : "体素加工任务提交失败",
            提交成功,
            规格.包围盒边长,
            父候选块数);
        return 提交成功;
    ...
    // 功能：按父存在、观察证据和基准版本查找可提交体素加工候选结果包。
    inline std::optional<视觉观察融合模块::结构_体素加工候选结果包> 查找体素颜色候选结果包(
        存在节点类* 父存在,
        I64 观察证据ID,
        I64 基准体素版本)
    {
        if (!父存在 || 观察证据ID <= 0 || !体素版本值有效(基准体素版本)) {
            return std::nullopt;
        }
        for (const auto& 候选包 : 视觉观察融合模块::读取体素加工候选结果包集合()) {
            if (候选包.父存在.获取() == 父存在
                && 候选包.输入观察证据ID == 观察证据ID
                && 候选包.基准体素版本 == 基准体素版本) {
                return 候选包;
    ...
    // 功能：判断体素子轮廓候选是否具备可提交的局部子体素候选。
    inline bool 体素子轮廓候选具备局部子体素(
        const 视觉观察融合模块::结构_体素子轮廓候选& 子候选) noexcept
    {
        return 子候选.候选ID > 0
            && 子候选.局部子体素候选ID > 0
            && 子候选.状态 == 视觉观察融合模块::枚举_体素子轮廓候选状态::可生成局部体素候选
            && 子候选.局部体素检查.输入有效
            && 子候选.局部体素检查.有占据
            && !子候选.局部体素占据候选.empty();
    }
    ...
    struct 结构_体素子候选映射结果 {
        I64 映射状态 = 体素子候选映射状态_未生成;
        I64 可映射候选数量 = 0;
        I64 子候选ID = 0;
        I64 局部子体素候选ID = 0;
        std::optional<视觉观察融合模块::结构_体素子轮廓候选> 子候选{};
    };

    // 功能：按父存在、观察证据、基准版本和可选子候选 ID 查找无歧义子候选映射。
    inline 结构_体素子候选映射结果 查找体素子候选映射(
        存在节点类* 父存在,
        I64 观察证据ID,
        I64 基准体素版本,
        I64 已有子候选ID)
    {
        结构_体素子候选映射结果 结果{};
        if (!父存在 || 观察证据ID <= 0 || !体素版本值有效(基准体素版本)) {
            结果.映射状态 = 体素子候选映射状态_输入非法;
            return 结果;
        }

        const auto 候选包 = 查找体素颜色候选结果包(父存在, 观察证据ID, 基准体素版本);
        if (!候选包) {
            结果.映射状态 = 体素子候选映射状态_缺候选包;
            return 结果;
        }
        if (候选包->基准体素版本 != 基准体素版本) {
            结果.映射状态 = 体素子候选映射状态_版本不匹配;
            return 结果;
        }

        for (const auto& 子候选 : 候选包->子轮廓候选集合) {
            if (!体素子轮廓候选具备局部子体素(子候选)) {
                continue;
            }
            if (已有子候选ID > 0 && 子候选.候选ID != 已有子候选ID) {
                continue;
            }
            ++结果.可映射候选数量;
            if (!结果.子候选) {
                结果.子候选 = 子候选;
                结果.子候选ID = 子候选.候选ID;
                结果.局部子体素候选ID = 子候选.局部子体素候选ID;
            }
        }

        if (结果.可映射候选数量 == 1 && 结果.子候选) {
            结果.映射状态 = 体素子候选映射状态_已映射;
        } else if (结果.可映射候选数量 == 0) {
            结果.映射状态 = 体素子候选映射状态_无可映射候选;
            结果.子候选ID = 0;
            结果.局部子体素候选ID = 0;
            结果.子候选.reset();
        } else {
            结果.映射状态 = 体素子候选映射状态_多可映射候选;
            结果.子候选ID = 0;
            结果.局部子体素候选ID = 0;
            结果.子候选.reset();
        }
    ...
    // 功能：提交入口裁决后把子候选映射和子平均颜色候选写成子存在正式结构化事实。
    inline 结构_体素子候选映射结果 写入体素子候选映射与颜色事实(
        存在节点类* 子存在,
        存在节点类* 父存在,
        I64 观察证据ID,
        I64 基准体素版本,
    ...
    {
        结构_体素子候选映射结果 结果{};
        auto* 子节点 = reinterpret_cast<基础信息节点类*>(子存在);
        if (!子节点) {
            结果.映射状态 = 体素子候选映射状态_输入非法;
            return 结果;
        }
        ...
        I64 已有子候选ID = 0;
        (void)读取基础节点I64(子节点, 特征_体素子候选ID(), 已有子候选ID);
        结果 = 查找体素子候选映射(父存在, 观察证据ID, 基准体素版本, 已有子候选ID);

        auto 写I64 = [&](const 语素入口节点类* 特征类型, I64 值) noexcept {
            (void)写入基础节点I64(子节点, 特征类型, 值, now);
        };

        写I64(特征_体素颜色来源观察证据ID(), 观察证据ID);
        写I64(特征_体素颜色来源基准体素版本(), 基准体素版本);
        写I64(特征_体素子候选映射状态(), 结果.映射状态);

        if (结果.映射状态 != 体素子候选映射状态_已映射 || !结果.子候选) {
            写I64(特征_体素子平均颜色事实状态(), 体素颜色事实状态_缺子候选映射);
            return 结果;
        }

        写I64(特征_体素子候选ID(), 结果.子候选ID);
        写I64(特征_体素局部子体素候选ID(), 结果.局部子体素候选ID);
        if (!体素颜色统计可写(结果.子候选->颜色统计)) {
            写I64(特征_体素子平均颜色事实状态(), 体素颜色事实状态_候选统计无效);
            return 结果;
        }

        写I64(特征_体素子平均颜色RGBA(), 体素颜色RGBA转I64(结果.子候选->颜色统计.平均颜色RGBA));
        写I64(
            特征_体素子平均颜色像素数量(),
            static_cast<I64>(std::min<std::uint64_t>(
                结果.子候选->颜色统计.像素数量,
                static_cast<std::uint64_t>((std::numeric_limits<I64>::max)()))));
        写I64(特征_体素子平均颜色事实状态(), 体素颜色事实状态_已写入);
        return 结果;
    }

    // 功能：提交入口裁决后把父基础颜色候选写成父存在正式颜色事实。
    inline I64 写入父体素基础颜色事实_由候选包(
        存在节点类* 父存在,
        I64 观察证据ID,
        I64 基准体素版本,
        时间戳 now)
    {
        auto* 父节点 = reinterpret_cast<基础信息节点类*>(父存在);
        if (!父节点 || 观察证据ID <= 0 || !体素版本值有效(基准体素版本)) {
            return 0;
        }

        I64 写入数量 = 0;
        auto 计数写入I64 = [&](const 语素入口节点类* 特征类型, I64 值) {
            if (写入基础节点I64(父节点, 特征类型, 值, now)) {
                ++写入数量;
            }
        };
        ...
        const auto 候选包 = 查找体素颜色候选结果包(父存在, 观察证据ID, 基准体素版本);
        if (!候选包) {
            计数写入I64(特征_体素父基础颜色事实状态(), 体素颜色事实状态_缺候选包);
            return 写入数量;
        }
        if (候选包->基准体素版本 != 基准体素版本) {
            计数写入I64(特征_体素父基础颜色事实状态(), 体素颜色事实状态_版本不匹配);
            return 写入数量;
        }
        if (!体素颜色统计可写(候选包->父基础颜色统计)) {
            计数写入I64(特征_体素父基础颜色事实状态(), 体素颜色事实状态_候选统计无效);
            return 写入数量;
        }

        计数写入I64(特征_体素父基础颜色RGBA(), 体素颜色RGBA转I64(候选包->父基础颜色统计.平均颜色RGBA));
        计数写入I64(
            特征_体素父基础颜色像素数量(),
            static_cast<I64>(std::min<std::uint64_t>(
                候选包->父基础颜色统计.像素数量,
                static_cast<std::uint64_t>((std::numeric_limits<I64>::max)()))));
        计数写入I64(特征_体素颜色来源观察证据ID(), 观察证据ID);
        计数写入I64(特征_体素颜色来源基准体素版本(), 基准体素版本);
        计数写入I64(特征_体素父基础颜色事实状态(), 体素颜色事实状态_已写入);
        return 写入数量;
    }

    // 功能：在自我侧提交入口补写已由体素加工线程产出的父基础颜色候选事实。
    inline I64 补写已完成体素父基础颜色事实_由候选包集合(时间戳 now)
    {
        const auto 候选包集合 = 视觉观察融合模块::读取体素加工候选结果包集合();
        if (候选包集合.empty()) {
            return 0;
        }

        std::vector<const 视觉观察融合模块::结构_体素加工候选结果包*> 每父存在最新候选包;
        for (const auto& 候选包 : 候选包集合) {
            if (候选包.处理状态 != 视觉观察融合模块::枚举_体素加工任务处理状态::已生成候选
                || !候选包.父存在.获取()
                || 候选包.输入观察证据ID <= 0
                || !体素版本值有效(候选包.基准体素版本)
                || !体素颜色统计可写(候选包.父基础颜色统计)) {
                continue;
            }
            ...
            auto 现有 = std::find_if(
                每父存在最新候选包.begin(),
                每父存在最新候选包.end(),
                [&候选包](const 视觉观察融合模块::结构_体素加工候选结果包* 已选) noexcept {
                    return 已选 && 已选->父存在.获取() == 候选包.父存在.获取();
                });
            if (现有 == 每父存在最新候选包.end()) {
                每父存在最新候选包.push_back(&候选包);
            } else if (*现有 && (*现有)->输入观察证据ID < 候选包.输入观察证据ID) {
                *现有 = &候选包;
            }
        }
        ...
        I64 写入总数 = 0;
        I64 写入父存在数 = 0;
        for (const auto* 候选包 : 每父存在最新候选包) {
            if (!候选包) {
                continue;
            }
            auto* 父节点 = reinterpret_cast<基础信息节点类*>(候选包->父存在.获取());
            if (!父节点) {
                continue;
            }
            ...
            I64 已有来源基准体素版本 = 0;
            I64 已有颜色事实状态 = 0;
            (void)读取基础节点I64(父节点, 特征_体素颜色来源观察证据ID(), 已有来源观察证据ID);
            (void)读取基础节点I64(父节点, 特征_体素颜色来源基准体素版本(), 已有来源基准体素版本);
            (void)读取基础节点I64(父节点, 特征_体素父基础颜色事实状态(), 已有颜色事实状态);
            if (已有颜色事实状态 == 体素颜色事实状态_已写入
                && 已有来源观察证据ID == 候选包->输入观察证据ID
                && 已有来源基准体素版本 == 候选包->基准体素版本) {
                continue;
            }

            const auto 本次写入 = 写入父体素基础颜色事实_由候选包(
                候选包->父存在.获取(),
                候选包->输入观察证据ID,
                候选包->基准体素版本,
                now);
    ...
    // 功能：已确认存在 E 新增闭合轮廓组后提交体素加工 worker，不直接写三维体素模型。
    inline I64 提交已确认存在轮廓组体素加工任务(
        存在节点类* 已确认存在,
        const 结构_外设观察像素簇摘要& 簇,
        I64 来源报告ID,
        时间戳 now)
    {
        (void)补写已完成体素父基础颜色事实_由候选包集合(now);

        auto 记录轮廓组触发诊断 = [&](const char* 阶段,
            const std::string& 原因,
            I64 观察证据ID,
            I64 基准体素版本,
            I64 写入数量,
            ...
            输出 << "E轮廓组体素加工触发诊断"
                ...
                << " | 原因=" << 原因
                << " | 成功=" << (成功 ? 1 : 0)
                << " | 目标E=" << (已确认存在 ? 已确认存在->获取主键() : std::string("空"))
                << " | 来源报告ID=" << 来源报告ID
                << " | 观察证据ID=" << 观察证据ID
                << " | 基准体素版本=" << 基准体素版本
                << " | 簇ID=" << 簇.外设内部簇ID
                << " | 来源空间候选ID=" << 簇.来源空间候选ID
                << " | 彩色轮廓句柄空=" << (簇.彩色轮廓局部图句柄.empty() ? 1 : 0)
                << " | 深度轮廓句柄空=" << (簇.深度轮廓局部图句柄.empty() ? 1 : 0)
                << " | 写入数量=" << 写入数量
                << " | 已提交体素加工任务=" << (提交体素加工任务 ? 1 : 0)
                << " | 不写三维体素模型=1";
            项目运行日志(输出.str());
        };

        auto* 目标节点 = reinterpret_cast<基础信息节点类*>(已确认存在);
        const I64 观察证据ID = 构造体素观察证据ID(来源报告ID, 簇);
        if (!目标节点 || 观察证据ID <= 0) {
            记录轮廓组触发诊断("入口检查", "目标E空或观察证据ID非法", 观察证据ID, 0, 0, false, false);
            return 0;
        }
        if (体素观察证据已登记或消费(目标节点, 观察证据ID)) {
            记录轮廓组触发诊断("幂等检查", "同源轮廓组已登记或已消费", 观察证据ID, 0, 0, false, true);
            return 0;
        }
        if (簇.彩色轮廓局部图句柄.empty() || 簇.深度轮廓局部图句柄.empty()) {
            记录轮廓组触发诊断("轮廓组检查", "缺彩色或深度轮廓句柄", 观察证据ID, 0, 0, false, false);
            return 0;
        }

        I64 基准体素版本 = 0;
        (void)读取基础节点I64(目标节点, 特征_体素模型版本(), 基准体素版本);
        I64 写入数量 = 0;
        auto 计数写入I64 = [&](const 语素入口节点类* 特征类型, I64 值) noexcept {
            if (写入基础节点I64(目标节点, 特征类型, 值, now)) {
                ++写入数量;
            }
        };
        计数写入I64(特征_体素观察证据ID(), 观察证据ID);
        计数写入I64(特征_体素观察证据来源报告ID(), 来源报告ID);
        计数写入I64(
            特征_体素观察证据来源簇ID(),
            簇.外设内部簇ID > 0 ? 簇.外设内部簇ID : 簇.来源空间候选ID);
        计数写入I64(特征_体素加工基准体素版本(), 基准体素版本);
        计数写入I64(特征_体素加工候选结果包状态(), 体素加工候选结果包状态_未生成);
        计数写入I64(特征_体素观察证据消费状态(), 体素观察证据消费状态_待加工);

        const auto 版本闸门 = 检查父体素候选版本闸门(目标节点, 基准体素版本);
        if (!父体素候选版本闸门可裁决(版本闸门)) {
            计数写入I64(
                特征_体素加工候选结果包状态(),
                父体素候选版本闸门版本变化挂起(版本闸门)
                    ? 体素加工候选结果包状态_版本变化挂起
                    : 体素加工候选结果包状态_条件不足);
            计数写入I64(
                特征_体素观察证据消费状态(),
            ...
            记录轮廓组触发诊断(
                "版本闸门",
                "父体素候选版本闸门不可裁决:状态=" + std::to_string(版本闸门.闸门状态),
                观察证据ID,
                基准体素版本,
                写入数量,
                false,
        ...
        auto* 体素特征 = 查找子特征(目标节点, 特征_三维体素模型());
        计数写入I64(特征_体素加工候选结果包状态(), 体素加工候选结果包状态_版本匹配待裁决);
        constexpr std::uint64_t 最大观察体素数 = 2000000;
        const bool 已提交体素加工任务 = 提交观察体素加工任务_由观察簇(
            已确认存在,
            体素特征,
            簇,
            观察证据ID,
            ...
            now);
        if (!已提交体素加工任务) {
            计数写入I64(特征_体素加工候选结果包状态(), 体素加工候选结果包状态_条件不足);
            计数写入I64(特征_体素观察证据消费状态(), 体素观察证据消费状态_拒绝);
        }
        记录轮廓组触发诊断(
            "提交worker",
            已提交体素加工任务 ? "已提交已确认E轮廓组体素加工任务" : "体素加工任务未提交",
            观察证据ID,
            基准体素版本,
            写入数量,
            已提交体素加工任务,
    ...
    // 功能：根据观察簇空间 AABB 写入已确认观察存在的三维体素模型特征。
    inline I64 写入观察存在三维体素特征(
        存在节点类* 观察存在,
        const 结构_外设观察像素簇摘要& 簇,
        I64 来源报告ID,
        时间戳 now)
    {
        ...
        auto 记录体素写入诊断 = [&](const char* 阶段,
            ...
            输出 << "观察体素特征写入诊断"
                ...
                << " | 空间坐标有效率=" << 簇.空间坐标有效率
                << " | 深度有效率=" << 簇.深度有效率
                << " | 空间范围X=" << 簇.空间范围最小X << ".." << 簇.空间范围最大X
                << " | 空间范围Y=" << 簇.空间范围最小Y << ".." << 簇.空间范围最大Y
                << " | 空间范围Z=" << 簇.空间范围最小Z << ".." << 簇.空间范围最大Z
                << " | 局部图=" << 簇.局部图宽度 << "x" << 簇.局部图高度
                << " | 写入数量=" << 写入数量
                << " | 已提交体素加工任务=" << (提交体素加工任务 ? 1 : 0)
                << " | 诊断不参与机器判断=1";
        ...
        if (!观察存在 || !观察簇空间范围可形成极值轮廓(簇)) {
            记录体素写入诊断("入口检查", "观察存在空或空间范围不可形成极值轮廓", 0, 0, 0, false, false);
            return 0;
        }

        auto* 观察节点 = reinterpret_cast<基础信息节点类*>(观察存在);
        const I64 观察证据ID = 构造体素观察证据ID(来源报告ID, 簇);
        if (!观察节点 || 观察证据ID <= 0 || 体素观察证据已消费(观察节点, 观察证据ID)) {
            记录体素写入诊断(
                "证据检查",
                !观察节点 ? "观察节点空" : (观察证据ID <= 0 ? "观察证据ID非法" : "观察证据已消费"),
                观察证据ID,
                0,
                0,
                false,
        ...
        I64 基准体素版本 = 0;
        (void)读取基础节点I64(观察节点, 特征_体素模型版本(), 基准体素版本);
        I64 写入数量 = 0;
        auto 计数写入I64 = [&](const 语素入口节点类* 特征类型, I64 值) noexcept {
            if (写入基础节点I64(观察节点, 特征类型, 值, now)) {
                ++写入数量;
            }
        };
        计数写入I64(特征_体素观察证据ID(), 观察证据ID);
        ...
        计数写入I64(特征_体素加工候选结果包状态(), 体素加工候选结果包状态_未生成);
        计数写入I64(特征_体素观察证据消费状态(), 体素观察证据消费状态_待加工);
        auto 拒绝体素观察证据 = [&]() noexcept {
            计数写入I64(特征_体素观察证据消费状态(), 体素观察证据消费状态_拒绝);
            return 写入数量;
        };

        constexpr std::uint32_t 最小体素边长_mm = 25;
        constexpr std::uint64_t 最大观察体素数 = 2000000;
        const auto 宽度 = 观察簇空间范围体素维度(
            簇.空间范围最小X,
            簇.空间范围最大X,
            最小体素边长_mm);
        const auto 高度 = 观察簇空间范围体素维度(
            簇.空间范围最小Y,
            簇.空间范围最大Y,
            最小体素边长_mm);
        const auto 深度 = 观察簇空间范围体素维度(
            簇.空间范围最小Z,
            簇.空间范围最大Z,
            最小体素边长_mm);
        const auto 体素总数 = 三维体素长方体总数(宽度, 高度, 深度);
        if (体素总数 == 0 || 体素总数 > 最大观察体素数) {
            记录体素写入诊断("体素维度检查", "体素总数为0或超过上限", 观察证据ID, 基准体素版本, 写入数量, false, false);
            return 拒绝体素观察证据();
        }

        auto* 体素特征 = 世界树.取或创建子特征_按类型(
            reinterpret_cast<基础信息节点类*>(观察存在),
            特征_三维体素模型());
        if (!体素特征) {
            记录体素写入诊断("体素特征确保", "三维体素模型特征为空", 观察证据ID, 基准体素版本, 写入数量, false, false);
            return 拒绝体素观察证据();
        }

        auto 占据位块 = 特征类::创建三维体素长方体占据位块(宽度, 高度, 深度);
        if (占据位块.empty()) {
            记录体素写入诊断("粗体素占据块", "长方体占据位块为空", 观察证据ID, 基准体素版本, 写入数量, false, false);
            return 拒绝体素观察证据();
        }
        std::fill(占据位块.begin(), 占据位块.end(), ~0ull);
        const auto 末块有效位 = 体素总数 % 64ull;
        if (末块有效位 != 0 && !占据位块.empty()) {
            占据位块.back() = (1ull << 末块有效位) - 1ull;
        }

        const auto 版本闸门 = 检查父体素候选版本闸门(观察节点, 基准体素版本);
        if (!父体素候选版本闸门可裁决(版本闸门)) {
            计数写入I64(
                特征_体素加工候选结果包状态(),
                父体素候选版本闸门版本变化挂起(版本闸门)
            ...
            记录体素写入诊断(
                "版本闸门",
                "父体素候选版本闸门不可裁决:状态=" + std::to_string(版本闸门.闸门状态)
                    + "|当前版本=" + std::to_string(版本闸门.当前体素版本),
                观察证据ID,
                基准体素版本,
                写入数量,
                false,
        ...
        if (!已提交体素加工任务) {
            计数写入I64(特征_体素加工候选结果包状态(), 体素加工候选结果包状态_条件不足);
            记录体素写入诊断("提交体素加工", "体素加工任务未提交", 观察证据ID, 基准体素版本, 写入数量, false, false);
        }

        const auto 写入结果 = 世界树.特征().写入三维体素长方体二分层链(
            世界树.值池(),
            体素特征,
            占据位块,
            宽度,
            ...
            now);
        if (写入结果.成功) {
            计数写入I64(特征_体素模型版本(), 观察证据ID);
            计数写入I64(特征_体素加工候选结果包状态(), 体素加工候选结果包状态_父体素已写入);
            写入数量 += 写入父体素基础颜色事实_由候选包(
                观察存在,
                观察证据ID,
                基准体素版本,
                now);
        ...
        记录体素写入诊断(
            "粗体素写入",
            写入结果.成功 ? "三维体素粗模型已写入" : "三维体素粗模型写入失败",
            观察证据ID,
            基准体素版本,
            写入数量,
            已提交体素加工任务,
            写入结果.成功);
        return 写入结果.成功 ? 写入数量 + 1 : 写入数量;
    }
        ...
        const char* 调用方) noexcept
    {
        ...
        auto 比较单项 = [&](const 语素入口节点类* 特征类型) noexcept {
            ...
            if (写入二次特征) {
                const bool 写入成功 = 世界树.写入轮廓比较二次特征(
                    二次特征父节点 ? 二次特征父节点 : 左宿主,
                    特征类型,
                    比较结果,
                    左特征,
    ...
    inline 存在节点类* 方法虚拟存在(方法类::节点类* 方法首节点, 时间戳 now) noexcept
    {
        ...
        if (auto* 已有虚拟存在 = 方法类::方法虚拟存在只读(方法首节点)) {
            return 已有虚拟存在;
        }
        return 方法虚拟存在服务类::取或创建方法虚拟存在(方法首节点, nullptr, now);
    }
    ...
    inline bool 条件节点已有结果子节点_条件结果对归并(方法类::节点类* 条件节点) noexcept
    {
        ...
        do {
            if (当前
                && 方法类::方法节点种类(当前) == 枚举_方法节点种类::方法结果节点
                && 当前->主信息.取结果节点信息()) {
                return true;
            }
            当前 = 当前 ? static_cast<方法类::节点类*>(当前->下) : nullptr;
    ...
    inline bool 方法具有已注册本能执行入口(方法类::节点类* 方法首节点) noexcept
    {
        ...
        const auto 本能ID = static_cast<枚举_本能方法ID>(
            static_cast<std::uint32_t>(方法类::方法本能ID(方法首节点)));
        ...
        I64 最近连续成功次数) noexcept
    {
        ...
        if (方法类::方法条件节点数量(方法首节点) <= 0) {
            return 方法状态_待条件节点();
        }
        if (方法类::方法条件结果对数量(方法首节点) <= 0) {
            return 方法状态_待条件结果对();
        }
        return 最近连续成功次数 > 3
            ? 方法状态_好用()
        ...
        枚举_本能方法ID 本能ID) noexcept
    {
        return 是D455缺报告环境诊断本能方法(本能ID)
            && 方法首节点
            && 方法类::方法是首节点(方法首节点)
            && 方法类::方法本能ID(方法首节点) == static_cast<I64>(本能ID)
            && 方法首节点已有条件节点(方法首节点);
    }
        ...
        时间戳 now) noexcept
    {
        ...
        if (方法类::方法是首节点(方法树锚点)
            && 方法类::方法本能ID(方法树锚点) == static_cast<I64>(本能ID)) {
        ...
        时间戳 判定时间 = 0) noexcept
    {
        ...
        I64 完备失败条件数量 = 0;
        if (结果.像素覆盖状态 != 观察事实状态_已覆盖) ++完备失败条件数量;
        if (结果.像素特征值承接状态 != 观察事实状态_已完成) ++完备失败条件数量;
        if (结果.坐标回查可用状态 != 观察事实状态_可用) ++完备失败条件数量;
        if (结果.帧内编号回查可用状态 != 观察事实状态_可用) ++完备失败条件数量;
        结果.观察事实完备失败条件数量 = 完备失败条件数量;
        结果.质量可用状态 = 观察事实布尔状态(
            结果.观察帧质量诊断摘要 == 1
            && 结果.帧质量评分 >= 观察质量最低评分
        ...
        I64 质量失败条件数量 = 0;
        if (结果.观察帧质量诊断摘要 != 1) ++质量失败条件数量;
        if (结果.帧质量评分 < 观察质量最低评分) ++质量失败条件数量;
        if (结果.深度有效率 < 观察质量最低深度有效率) ++质量失败条件数量;
        if (结果.空间坐标有效率 < 观察质量最低空间坐标有效率) ++质量失败条件数量;
        结果.质量失败条件数量 = 质量失败条件数量;
        补全当前观察新鲜度状态(结果, 判定时间);
    ...
    struct 结构_被动识别外设观察材料结果 {
        bool 已运行 = false;
        bool 来源报告存在 = false;
        bool 材料可进入识别 = false;
        bool 材料可交付观察方法 = false;
        bool 唯一已有存在 = false;
        I64 报告ID = 0;
        I64 候选簇数量 = 0;
        I64 上游验证状态 = 外设观察候选验证状态_未验证;
        I64 同一性状态 = 外设观察存在自我存在同一性状态_未比较;
        I64 同一性评分 = 0;
    ...
    struct 结构_P12体素融合输入组只读摘要 {
        I64 输入组状态 = 体素融合输入组状态_未生成;
        I64 阻断原因掩码 = 0;
        I64 观察证据ID = 0;
        I64 基准体素版本 = 0;
        I64 当前体素版本 = 0;
        ...
        I64 局部子体素候选数量 = 0;
        I64 有深度支撑子候选数量 = 0;
        I64 待处理状态 = 体素融合待处理状态_未生成;
        I64 待处理幂等键 = 0;
        I64 待处理挂起原因掩码 = 0;
        I64 待处理重复命中次数 = 0;
        I64 子轮廓候选状态 = 体素融合子轮廓候选状态_未生成;
        I64 子轮廓候选阻断原因掩码 = 0;
        I64 子轮廓候选数量 = 0;
        I64 可生成局部子体素候选数量 = 0;
        I64 父候选触碰外边界数量 = 0;
        I64 无融合点候选包数量 = 0;
        I64 主模型候选状态 = 体素融合主模型候选状态_未生成;
        I64 主模型候选阻断原因掩码 = 0;
        I64 主模型候选来源观察证据ID = 0;
        I64 主模型候选基准体素版本 = 0;
        I64 主模型候选融合点数量 = 0;
    ...
    inline std::uint64_t P12混入U64(std::uint64_t h, std::uint64_t x) noexcept
    {
        h ^= x;
        h *= 1099511628211ULL;
        return h;
    ...
    inline std::uint64_t P12混入字符串(std::uint64_t h, const std::string& 文本) noexcept
    {
        h = P12混入U64(h, static_cast<std::uint64_t>(文本.size()));
        for (const unsigned char 字符 : 文本) {
            h = P12混入U64(h, static_cast<std::uint64_t>(字符));
        }
        return h;
    }

    // 功能：用 E、C 来源证据和基准体素版本生成 P12 待处理材料幂等键。
    inline I64 构造P12体素融合待处理幂等键(
        const 结构_被动识别外设观察材料结果& 结果,
        const 结构_P12体素融合输入组只读摘要& 摘要) noexcept
    {
        if (!结果.识别存在
            || 摘要.观察证据ID <= 0
            || !体素版本值有效(摘要.基准体素版本)) {
        ...
        h = P12混入字符串(h, 结果.识别存在->获取主键());
        h = P12混入U64(h, static_cast<std::uint64_t>(摘要.观察证据ID));
        h = P12混入U64(h, static_cast<std::uint64_t>(摘要.基准体素版本));
        h = P12混入U64(h, static_cast<std::uint64_t>(结果.报告ID));
        const auto 值 = h & 0x7fffffffffffffffULL;
        if (值 == 0ULL) {
            return 1;
        }
        if (值 == static_cast<std::uint64_t>((std::numeric_limits<I64>::max)())) {
            return (std::numeric_limits<I64>::max)() - 1;
        }
        return static_cast<I64>(值);
    }

    // 功能：把 P12 运行期计数压入 I64 计数范围。
    inline I64 P12计数转I64(const std::uint64_t 值) noexcept
    {
    ...
    // 功能：对 P12 计数做饱和相加，避免摘要计数溢出。
    inline I64 P12饱和相加(const I64 当前, const I64 增量) noexcept
    {
        if (增量 <= 0) return 当前;
        if (当前 >= (std::numeric_limits<I64>::max)() - 增量) {
            return (std::numeric_limits<I64>::max)();
        }
        return 当前 + 增量;
    }

    // 功能：判断 P12 主模型候选是否处于无旧稳定体素主模型的第一版写入阶段。
    inline bool P12体素融合第一版主模型候选(const I64 基准体素版本) noexcept
    {
        return 基准体素版本 == 0;
    }

    // 功能：只读收束 P12 体素融合输入组材料，不写稳定体素主模型。
    inline 结构_P12体素融合输入组只读摘要 读取P12体素融合输入组只读摘要(
        const 结构_被动识别外设观察材料结果& 结果) noexcept
    {
        结构_P12体素融合输入组只读摘要 摘要{};
        if (!结果.识别存在) {
            摘要.阻断原因掩码 |= 体素融合输入阻断_缺目标存在;
        }
        if (结果.同一性状态 != 外设观察存在自我存在同一性状态_已同一
            || !结果.唯一已有存在) {
            摘要.阻断原因掩码 |= 体素融合输入阻断_同一性未收束;
        }

        for (const auto& 项 : 结果.确认方案.项集合) {
            if (项.方案类型 != 外设观察存在候选确认方案_合并
                || !项.目标已知存在
                || (结果.识别存在 && 项.目标已知存在 != 结果.识别存在)) {
                continue;
            }

            const I64 观察证据ID = 构造体素观察证据ID(结果.报告ID, 项.簇);
            if (观察证据ID <= 0) {
                摘要.阻断原因掩码 |= 体素融合输入阻断_缺观察体素证据;
                continue;
            }

            auto* 目标节点 = reinterpret_cast<基础信息节点类*>(项.目标已知存在);
            I64 基准体素版本 = 0;
            I64 当前体素版本 = 0;
            (void)读取基础节点I64(目标节点, 特征_体素加工基准体素版本(), 基准体素版本);
            (void)读取基础节点I64(目标节点, 特征_体素模型版本(), 当前体素版本);
            if (摘要.观察证据ID == 0) {
                摘要.观察证据ID = 观察证据ID;
            }
            if (摘要.基准体素版本 == 0) {
            ...
            auto* 体素特征 = 查找子特征(目标节点, 特征_三维体素模型());
            VecU句柄 稳定体素根句柄{};
            const bool 第一版主模型候选 = P12体素融合第一版主模型候选(基准体素版本);
            if ((!体素特征 || !世界树.特征().读取三维体素特征值(体素特征, 稳定体素根句柄))
                && !第一版主模型候选) {
                摘要.阻断原因掩码 |= 体素融合输入阻断_缺稳定体素模型;
            }
            if (!体素版本值有效(基准体素版本) && !第一版主模型候选) {
                摘要.阻断原因掩码 |= 体素融合输入阻断_缺基准版本;
            }
            if (!第一版主模型候选) {
                const auto 版本闸门 = 检查父体素候选版本闸门(目标节点, 基准体素版本);
                if (父体素候选版本闸门版本变化挂起(版本闸门)) {
                    摘要.阻断原因掩码 |= 体素融合输入阻断_基准版本失配;
                } else if (!父体素候选版本闸门可裁决(版本闸门)) {
                    摘要.阻断原因掩码 |= 体素融合输入阻断_缺基准版本;
                }
            }

            const auto 候选包 = 查找体素颜色候选结果包(
                项.目标已知存在,
                观察证据ID,
                基准体素版本);
            if (!候选包) {
                摘要.阻断原因掩码 |= 体素融合输入阻断_缺候选结果包;
                摘要.子轮廓候选阻断原因掩码 |= 体素融合子轮廓候选阻断_缺候选结果包;
                continue;
            }
            ++摘要.候选结果包数量;
            摘要.子轮廓候选数量 += 候选包->子轮廓候选数量;
            摘要.有深度支撑子候选数量 += 候选包->有深度支撑子候选数量;
            const auto 包融合点数量 = 候选包->融合点检查.重叠融合点数量
                + 候选包->融合点检查.相邻融合点数量;
            摘要.主模型候选融合点数量 = P12饱和相加(
                摘要.主模型候选融合点数量,
                P12计数转I64(包融合点数量));
            if (候选包->是否触碰外边界) {
                ++摘要.父候选触碰外边界数量;
                摘要.主模型候选越界数量 = P12饱和相加(摘要.主模型候选越界数量, 1);
                摘要.子轮廓候选阻断原因掩码 |= 体素融合子轮廓候选阻断_父候选触碰外边界;
            }
            if (!候选包->是否存在融合点 && !第一版主模型候选) {
                ++摘要.无融合点候选包数量;
                摘要.主模型候选冲突数量 = P12饱和相加(摘要.主模型候选冲突数量, 1);
                摘要.子轮廓候选阻断原因掩码 |= 体素融合子轮廓候选阻断_无融合点;
            }
            for (const auto& 子候选 : 候选包->子轮廓候选集合) {
                if (体素子轮廓候选具备局部子体素(子候选)) {
                    ++摘要.局部子体素候选数量;
                    ...
                    if (子候选.局部体素检查.触碰外边界) {
                        ...
                        摘要.主模型更新候选数量 = P12饱和相加(摘要.主模型更新候选数量, 1);
                    }
                } else {
                    摘要.主模型候选冲突数量 = P12饱和相加(摘要.主模型候选冲突数量, 1);
                    摘要.子轮廓候选阻断原因掩码 |= 体素融合子轮廓候选阻断_子候选质量不足;
                    if (!子候选.有深度空间支撑 || 子候选.深度支撑像素数量 == 0) {
                        摘要.子轮廓候选阻断原因掩码 |= 体素融合子轮廓候选阻断_缺深度支撑;
                    }
                }
            }
        }
        ...
        if (摘要.局部子体素候选数量 <= 0) {
            摘要.阻断原因掩码 |= 体素融合输入阻断_缺局部子体素候选;
            摘要.子轮廓候选阻断原因掩码 |= 体素融合子轮廓候选阻断_子候选质量不足;
        }
        摘要.输入组状态 = 摘要.阻断原因掩码 == 0
            ? 体素融合输入组状态_只读摘要已生成
            : 体素融合输入组状态_阻断;
        摘要.子轮廓候选状态 = 摘要.子轮廓候选阻断原因掩码 == 0
            ? 体素融合子轮廓候选状态_已收束
            : 体素融合子轮廓候选状态_阻断;
        摘要.主模型候选来源观察证据ID = 摘要.观察证据ID;
        摘要.主模型候选基准体素版本 = 摘要.基准体素版本;
        if (摘要.子轮廓候选状态 != 体素融合子轮廓候选状态_已收束) {
            摘要.主模型候选阻断原因掩码 |= 体素融合主模型候选阻断_子轮廓候选阻断;
        }
        const bool 第一版主模型候选 = P12体素融合第一版主模型候选(摘要.基准体素版本);
        if (!第一版主模型候选
            && (!体素版本值有效(摘要.基准体素版本)
                || (体素版本值有效(摘要.当前体素版本) && 摘要.基准体素版本 != 摘要.当前体素版本))) {
            摘要.主模型候选阻断原因掩码 |= 体素融合主模型候选阻断_基准版本失配;
        }
        if (摘要.主模型候选融合点数量 <= 0 && !第一版主模型候选) {
            摘要.主模型候选阻断原因掩码 |= 体素融合主模型候选阻断_缺融合点;
        }
        if (摘要.主模型候选越界数量 > 0) {
            摘要.主模型候选阻断原因掩码 |= 体素融合主模型候选阻断_越界;
        }
        if (摘要.主模型候选冲突数量 > 0) {
            摘要.主模型候选阻断原因掩码 |= 体素融合主模型候选阻断_冲突;
        }
        if (摘要.主模型更新候选数量 <= 0) {
            摘要.主模型候选阻断原因掩码 |= 体素融合主模型候选阻断_缺可生成子体素候选;
        }
        摘要.主模型候选状态 = 摘要.主模型候选阻断原因掩码 == 0
            ? 体素融合主模型候选状态_已生成
            : 体素融合主模型候选状态_阻断;
        return 摘要;
    }

    // 功能：对 P12 主模型融合候选执行第一版最小写入校验。
    inline bool P12主模型融合候选最小写入校验通过(
        const 视觉观察融合模块::结构_体素加工候选结果包& 候选包,
        const I64 基准体素版本) noexcept
    {
        if (候选包.输入观察证据ID <= 0
            || 候选包.包围盒边长 < 3
            || 候选包.父体素占据候选快照.empty()
            || 候选包.父体素检查.输入有效 == false
            || 候选包.父体素检查.有占据 == false) {
            return false;
        }
        if (候选包.是否触碰外边界) {
    ...
    // 功能：校验局部体素候选进入稳定体素写入前的隔离闸。
    inline bool P5局部体素到稳定体素隔离闸通过(
        const 结构_被动识别外设观察材料结果& 结果,
        const 结构_P12体素融合输入组只读摘要& 摘要,
        const 视觉观察融合模块::结构_体素加工候选结果包& 候选包) noexcept
    {
        if (!结果.已运行
            || !结果.来源报告存在
            || !结果.材料可进入识别
            ...
            || !结果.识别存在
            || !结果.唯一已有存在
            || 结果.同一性状态 != 外设观察存在自我存在同一性状态_已同一
            || 结果.归属状态 != 外设观察存在自我归属状态_已归属) {
            return false;
        }
        if (摘要.输入组状态 != 体素融合输入组状态_只读摘要已生成
            || 摘要.阻断原因掩码 != 0
            || 摘要.观察证据ID <= 0
            || 摘要.主模型候选状态 != 体素融合主模型候选状态_已生成
            || 摘要.主模型候选阻断原因掩码 != 0
            || 摘要.主模型候选来源观察证据ID != 摘要.观察证据ID
            || 摘要.主模型候选基准体素版本 != 摘要.基准体素版本
            || (摘要.待处理状态 != 体素融合待处理状态_已生成
                && 摘要.待处理状态 != 体素融合待处理状态_同键已存在)) {
            return false;
        }
        if (候选包.输入观察证据ID != 摘要.观察证据ID
            || 候选包.基准体素版本 != 摘要.基准体素版本) {
            return false;
        }
        return P12主模型融合候选最小写入校验通过(候选包, 摘要.基准体素版本);
    }

    // 功能：将 P12 合格主模型融合候选写入目标 E 的稳定三维体素主模型。
    inline bool 写入P12体素融合主模型候选到E(
        const 结构_被动识别外设观察材料结果& 结果,
        const 结构_P12体素融合输入组只读摘要& 摘要,
        时间戳 now) noexcept
    {
        ...
        const auto 候选包 = 查找体素颜色候选结果包(
            ...
            摘要.基准体素版本);
        if (!候选包
            || !P5局部体素到稳定体素隔离闸通过(结果, 摘要, *候选包)) {
            return false;
        }

        auto* 目标节点 = reinterpret_cast<基础信息节点类*>(结果.识别存在);
        auto* 体素特征 = 世界树.取或创建子特征_按类型(
            目标节点,
            特征_三维体素模型());
        if (!体素特征) {
        ...
        const auto 细分层数 = 特征类::三维体素包围立方体细分层数(
            候选包->包围盒边长,
            候选包->包围盒边长,
            候选包->包围盒边长);
        if (!细分层数.has_value()) {
        ...
        constexpr std::uint32_t 最小体素边长_mm = 25;
        const auto 写入结果 = 世界树.特征().写入三维体素二分层链(
            世界树.值池(),
            体素特征,
            候选包->父体素占据候选快照,
            *细分层数,
    ...
    // 功能：把 P12 体素融合输入组只读摘要写到运行宿主，供后续切片读取。
    inline void 写入P12体素融合输入组只读摘要(
        基础信息节点类* 宿主,
        const 结构_被动识别外设观察材料结果& 结果,
        时间戳 now,
        const bool 允许主模型写入) noexcept
    {
        if (!宿主 || !结果.已运行) {
            return;
        }
        auto 摘要 = 读取P12体素融合输入组只读摘要(结果);
        摘要.待处理幂等键 = 构造P12体素融合待处理幂等键(结果, 摘要);
        if (摘要.输入组状态 != 体素融合输入组状态_只读摘要已生成) {
            摘要.待处理挂起原因掩码 |= 体素融合待处理挂起_输入组阻断;
        }
        if (摘要.待处理幂等键 <= 0) {
            摘要.待处理挂起原因掩码 |= 体素融合待处理挂起_缺幂等材料;
        }
        if ((摘要.阻断原因掩码 & 体素融合输入阻断_基准版本失配) != 0) {
            摘要.待处理挂起原因掩码 |= 体素融合待处理挂起_基准版本失配;
        }
        if (摘要.待处理挂起原因掩码 != 0) {
            摘要.待处理状态 = 体素融合待处理状态_挂起;
        } else {
            I64 已有幂等键 = 0;
            I64 已有待处理状态 = 0;
            I64 已有重复命中次数 = 0;
            const bool 同键已存在 =
                读取基础节点I64(宿主, 特征_体素融合待处理幂等键(), 已有幂等键)
                && 已有幂等键 == 摘要.待处理幂等键
                && 读取基础节点I64(宿主, 特征_体素融合待处理状态(), 已有待处理状态)
                && (已有待处理状态 == 体素融合待处理状态_已生成
                    || 已有待处理状态 == 体素融合待处理状态_同键已存在);
            if (同键已存在) {
                (void)读取基础节点I64(宿主, 特征_体素融合待处理重复命中次数(), 已有重复命中次数);
                摘要.待处理状态 = 体素融合待处理状态_同键已存在;
                if (已有重复命中次数 >= (std::numeric_limits<I64>::max)() - 2) {
                    摘要.待处理重复命中次数 = (std::numeric_limits<I64>::max)() - 1;
                } else {
                    摘要.待处理重复命中次数 = 已有重复命中次数 > 0 ? 已有重复命中次数 + 1 : 1;
                }
            } else {
                摘要.待处理状态 = 体素融合待处理状态_已生成;
            }
        }
        if (摘要.待处理状态 != 体素融合待处理状态_已生成
            && 摘要.待处理状态 != 体素融合待处理状态_同键已存在) {
            摘要.子轮廓候选阻断原因掩码 |= 体素融合子轮廓候选阻断_缺待处理材料;
            摘要.子轮廓候选状态 = 体素融合子轮廓候选状态_阻断;
            摘要.主模型候选阻断原因掩码 |= 体素融合主模型候选阻断_缺待处理材料;
            摘要.主模型候选状态 = 体素融合主模型候选状态_阻断;
        }
        (void)写入基础节点I64(宿主, 特征_体素融合输入组状态(), 摘要.输入组状态, now);
        (void)写入基础节点I64(宿主, 特征_体素融合输入阻断原因掩码(), 摘要.阻断原因掩码, now);
        (void)写入基础节点I64(宿主, 特征_体素融合输入观察证据ID(), 摘要.观察证据ID, now);
        (void)写入基础节点I64(宿主, 特征_体素融合输入基准体素版本(), 摘要.基准体素版本, now);
        (void)写入基础节点I64(宿主, 特征_体素融合输入当前体素版本(), 摘要.当前体素版本, now);
        (void)写入基础节点I64(宿主, 特征_体素融合输入候选结果包数量(), 摘要.候选结果包数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合输入局部子体素候选数量(), 摘要.局部子体素候选数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合输入有深度支撑子候选数量(), 摘要.有深度支撑子候选数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合待处理状态(), 摘要.待处理状态, now);
        (void)写入基础节点I64(宿主, 特征_体素融合待处理幂等键(), 摘要.待处理幂等键, now);
        (void)写入基础节点I64(宿主, 特征_体素融合待处理挂起原因掩码(), 摘要.待处理挂起原因掩码, now);
        (void)写入基础节点I64(宿主, 特征_体素融合待处理重复命中次数(), 摘要.待处理重复命中次数, now);
        (void)写入基础节点I64(宿主, 特征_体素融合子轮廓候选状态(), 摘要.子轮廓候选状态, now);
        (void)写入基础节点I64(宿主, 特征_体素融合子轮廓候选阻断原因掩码(), 摘要.子轮廓候选阻断原因掩码, now);
        (void)写入基础节点I64(宿主, 特征_体素融合子轮廓候选数量(), 摘要.子轮廓候选数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合可生成局部子体素候选数量(), 摘要.可生成局部子体素候选数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合父候选触碰外边界数量(), 摘要.父候选触碰外边界数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合无融合点候选包数量(), 摘要.无融合点候选包数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合主模型候选状态(), 摘要.主模型候选状态, now);
        (void)写入基础节点I64(宿主, 特征_体素融合主模型候选阻断原因掩码(), 摘要.主模型候选阻断原因掩码, now);
        (void)写入基础节点I64(宿主, 特征_体素融合主模型候选来源观察证据ID(), 摘要.主模型候选来源观察证据ID, now);
        (void)写入基础节点I64(宿主, 特征_体素融合主模型候选基准体素版本(), 摘要.主模型候选基准体素版本, now);
        (void)写入基础节点I64(宿主, 特征_体素融合主模型候选融合点数量(), 摘要.主模型候选融合点数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合主模型候选冲突数量(), 摘要.主模型候选冲突数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合主模型候选越界数量(), 摘要.主模型候选越界数量, now);
        (void)写入基础节点I64(宿主, 特征_体素融合主模型更新候选数量(), 摘要.主模型更新候选数量, now);
        if (允许主模型写入) {
            (void)写入P12体素融合主模型候选到E(结果, 摘要, now);
        }
    }

    struct 结构_观察内部治理写入结果 {
        I64 记录状态 = 观察内部治理记录状态_未生成;
        I64 新建存在数量 = 0;
        I64 更新已有存在数量 = 0;
        I64 写入特征数量 = 0;
        I64 处理项数量 = 0;
        I64 写入失败数量 = 0;
        动态节点类* 被动动作动态 = nullptr;
    };

    inline constexpr I64 观察写入闸门阻断_未运行 = 1;
    inline constexpr I64 观察写入闸门阻断_缺可交付材料 = 2;
    inline constexpr I64 观察写入闸门阻断_上游未验证 = 4;
    inline constexpr I64 观察写入闸门阻断_缺候选簇 = 8;
    inline constexpr I64 观察写入闸门阻断_缺可提交项 = 16;
    inline constexpr I64 观察写入闸门阻断_存在冲突 = 32;
    inline constexpr I64 观察写入闸门阻断_证据不足 = 64;
    inline constexpr I64 观察写入闸门阻断_同一性不成立 = 128;
    inline constexpr I64 观察写入闸门阻断_归属不成立 = 256;
    inline constexpr I64 观察写入闸门阻断_缺新建或合并数量 = 512;
    inline constexpr I64 观察写入闸门阻断_清晰度不足 = 1024;
    inline constexpr I64 观察写入闸门阻断_稳定复现不足 = 2048;

    // 功能：收束确认方案中候选簇清晰度材料是否阻断观察写入。
    inline bool 被动识别确认方案存在清晰度阻断(
        const 结构_外设观察存在确认方案& 方案) noexcept
    {
        for (const auto& 项 : 方案.项集合) {
            if ((项.证据不足原因 & 外设观察验证缺失原因_材料未达观察承接质量) != 0
                || (项.证据不足原因 & 外设观察验证缺失原因_缺像素归属材料) != 0) {
                return true;
            }
            const auto& 簇 = 项.簇;
            const bool 深度明确不足 =
                簇.深度有效率 > 0 && 簇.深度有效率 < 观察质量最低深度有效率;
            const bool 空间明确不足 =
                簇.空间坐标有效率 > 0 && 簇.空间坐标有效率 < 观察质量最低空间坐标有效率;
            const bool 轮廓明确不足 =
                簇.轮廓置信度 > 0 && 簇.轮廓置信度 < 观察质量最低评分;
            if (项.允许提交状态 > 0 && (深度明确不足 || 空间明确不足 || 轮廓明确不足)) {
                return true;
            }
        }
        return false;
    ...
    // 功能：收束确认方案中跨帧稳定复现材料是否阻断观察写入。
    inline bool 被动识别确认方案存在稳定复现阻断(
        const 结构_外设观察存在确认方案& 方案) noexcept
    {
        for (const auto& 项 : 方案.项集合) {
            if ((项.证据不足原因 & 外设观察验证缺失原因_缺跨帧同一性证据) != 0) {
                return true;
            }
            if (项.允许提交状态 > 0
                && (项.跨帧匹配状态 <= 0
    ...
    // 功能：收束被动识别材料被观察写入闸门阻断的结构化原因掩码。
    inline I64 被动识别观察写入闸门阻断原因掩码(
        const 结构_被动识别外设观察材料结果& 结果) noexcept
    {
        I64 原因 = 0;
        if (!结果.已运行) 原因 |= 观察写入闸门阻断_未运行;
        if (!结果.材料可交付观察方法) 原因 |= 观察写入闸门阻断_缺可交付材料;
        if (结果.上游验证状态 != 外设观察候选验证状态_已验证) 原因 |= 观察写入闸门阻断_上游未验证;
        if (结果.候选簇数量 <= 0) 原因 |= 观察写入闸门阻断_缺候选簇;
        if (结果.可提交数量 <= 0) 原因 |= 观察写入闸门阻断_缺可提交项;
        if (结果.冲突数量 > 0) 原因 |= 观察写入闸门阻断_存在冲突;
        if (结果.证据不足数量 > 0) 原因 |= 观察写入闸门阻断_证据不足;
        if (结果.同一性状态 == 外设观察存在自我存在同一性状态_冲突
            || 结果.同一性状态 == 外设观察存在自我存在同一性状态_证据不足
            || 结果.同一性状态 == 外设观察存在自我存在同一性状态_未比较) {
            原因 |= 观察写入闸门阻断_同一性不成立;
        }
        if (结果.归属状态 == 外设观察存在自我归属状态_冲突
            || 结果.归属状态 == 外设观察存在自我归属状态_证据不足
            || 结果.归属状态 == 外设观察存在自我归属状态_未归属) {
            原因 |= 观察写入闸门阻断_归属不成立;
        }
        const bool 可合并已有存在 =
            结果.同一性状态 == 外设观察存在自我存在同一性状态_已同一
            && 结果.归属状态 == 外设观察存在自我归属状态_已归属
            && 结果.合并数量 > 0;
        const bool 可建立观察候选存在 =
            结果.同一性状态 == 外设观察存在自我存在同一性状态_未命中已知存在
            && 结果.归属状态 == 外设观察存在自我归属状态_待建立
            && 结果.新建数量 > 0;
        if (!可合并已有存在 && !可建立观察候选存在) {
            原因 |= 观察写入闸门阻断_缺新建或合并数量;
        }
        if (被动识别确认方案存在清晰度阻断(结果.确认方案)) {
            原因 |= 观察写入闸门阻断_清晰度不足;
        }
        if (被动识别确认方案存在稳定复现阻断(结果.确认方案)) {
            原因 |= 观察写入闸门阻断_稳定复现不足;
        }
        return 原因;
    }

    // 功能：收束被动识别材料是否允许进入观察写入路径。
    inline bool 被动识别结果满足观察写入收束闸门(
        const 结构_被动识别外设观察材料结果& 结果) noexcept
    {
        return 被动识别观察写入闸门阻断原因掩码(结果) == 0;
    }

    // 功能：把确认方案项的跨帧证据收束为观察候选稳定复现状态。
    inline I64 外设观察存在确认方案项稳定复现状态(
        const 结构_外设观察存在确认方案项& 项) noexcept
    {
        if ((项.证据不足原因 & 外设观察验证缺失原因_缺跨帧同一性证据) != 0) {
            return 外设观察存在稳定复现状态_待复现;
        }
        if (项.跨帧匹配状态 > 0
            && 项.跨帧连续命中次数 >= 外设观察存在同一性最小证据帧数) {
            return 外设观察存在稳定复现状态_稳定;
        }
        if (项.跨帧匹配状态 > 0 || 项.跨帧连续命中次数 > 0) {
            return 外设观察存在稳定复现状态_部分稳定;
        }
        if (项.方案类型 == 外设观察存在候选确认方案_证据不足) {
            return 外设观察存在稳定复现状态_证据不足;
        }
        return 外设观察存在稳定复现状态_待复现;
    }

    // 功能：把确认方案项收束为观察候选 C 的确认状态，不产生 C 到 E 的事实归属。
    inline I64 外设观察存在确认方案项观察候选确认状态(
        const 结构_外设观察存在确认方案项& 项) noexcept
    {
        ...
        if (项.方案类型 == 外设观察存在候选确认方案_证据不足) {
            return (项.证据不足原因 & 外设观察验证缺失原因_缺跨帧同一性证据) != 0
                ? 观察存在确认状态_待确认
                : 观察存在确认状态_未确认;
        }
        if (项.方案类型 == 外设观察存在候选确认方案_新建
            || 项.方案类型 == 外设观察存在候选确认方案_合并) {
            return 外设观察存在确认方案项稳定复现状态(项) == 外设观察存在稳定复现状态_稳定
                && 项.允许提交状态 > 0
                ? 观察存在确认状态_已验证
                : 观察存在确认状态_待确认;
        }
    ...
    // 功能：写入观察候选 C 的确认状态和稳定复现状态。
    inline I64 写入观察候选C收束状态(
        基础信息节点类* 宿主,
    ...
    // 功能：把被动识别观察写入闸门原因转换为 P11 标准映射缺口原因。
    inline I64 被动识别观察闸门原因转P11映射缺口原因(I64 闸门原因) noexcept
    {
        I64 输出 = 0;
        if ((闸门原因 & (观察写入闸门阻断_未运行 | 观察写入闸门阻断_上游未验证)) != 0) {
            输出 |= 映射缺口原因_识别正式结果不可读;
        }
        if ((闸门原因 & (观察写入闸门阻断_缺候选簇 | 观察写入闸门阻断_缺可提交项)) != 0) {
            输出 |= 映射缺口原因_计数不可读;
        }
        if ((闸门原因 & 观察写入闸门阻断_缺新建或合并数量) != 0) {
            输出 |= 映射缺口原因_未稳定对应单位;
        }
        if ((闸门原因 & (观察写入闸门阻断_存在冲突
                | 观察写入闸门阻断_同一性不成立
                | 观察写入闸门阻断_归属不成立)) != 0) {
            输出 |= 映射缺口原因_CE多重对应冲突;
        }
        if ((闸门原因 & (观察写入闸门阻断_证据不足
                | 观察写入闸门阻断_稳定复现不足)) != 0) {
            输出 |= 映射缺口原因_证据不足;
        }
        if ((闸门原因 & (观察写入闸门阻断_缺可交付材料
                | 观察写入闸门阻断_清晰度不足)) != 0) {
            输出 |= 映射缺口原因_来源材料不可交付;
        }
        return 输出;
    ...
    // 功能：把 P11 映射阻断原因标准化为 D5 可回查的缺口证据摘要。
    inline void 写入P11结构化缺口摘要(
        基础信息节点类* 宿主,
        I64 映射缺口原因掩码,
        I64 先验版本闸门缺口原因掩码,
        时间戳 now) noexcept
    {
        if (!宿主) return;
        const I64 合并缺口原因掩码 = 映射缺口原因掩码
            | (先验版本闸门缺口原因掩码 != 0
                ? 映射缺口原因_视觉先验版本闸门不通过
                : 0);
        (void)写入基础节点I64(宿主, 特征_映射缺口原因掩码(), 合并缺口原因掩码, now);
        if (合并缺口原因掩码 == 0) {
            auto 清理缺口特征 = [&](const 语素入口节点类* 特征类型) noexcept {
                auto* 特征 = 查找子特征(宿主, 特征类型);
                if (特征) {
                    (void)世界树.删除特征(特征);
                }
            ...
            清理缺口特征(特征_来源缺口());
            清理缺口特征(特征_补观察缺失原因());
            (void)写入基础节点I64(宿主, 特征_补观察缺口状态(), 0, now);
            (void)写入基础节点I64(宿主, 特征_质量缺口状态(), 观察质量缺口状态_不存在, now);
            return;
        }

        const 语素入口节点类* 来源缺口 = nullptr;
        if ((合并缺口原因掩码 & 映射缺口原因_识别正式结果不可读) != 0) {
            来源缺口 = 特征_外设观察存在候选确认方案取得状态();
        } else if ((合并缺口原因掩码 & 映射缺口原因_计数不可读) != 0) {
            来源缺口 = 特征_当前观察范围有效可观测单位数量();
        } else if ((合并缺口原因掩码 & 映射缺口原因_提交确认链不可读) != 0) {
            来源缺口 = 特征_外设观察存在事实提交状态();
        } else if ((合并缺口原因掩码 & 映射缺口原因_未稳定对应单位) != 0) {
            来源缺口 = 特征_未稳定对应存在可观测单位数量();
        } else if ((合并缺口原因掩码 & 映射缺口原因_CE多重对应冲突) != 0) {
            来源缺口 = 特征_多重对应冲突可观测单位数量();
        } else if ((合并缺口原因掩码 & 映射缺口原因_证据不足) != 0) {
            来源缺口 = 特征_外设观察存在候选确认证据不足数量();
        } else if ((合并缺口原因掩码 & 映射缺口原因_来源材料不可交付) != 0) {
            来源缺口 = 特征_外设观察材料可回查状态();
        } else if ((合并缺口原因掩码 & 映射缺口原因_视觉先验版本闸门不通过) != 0) {
            来源缺口 = 特征_先验版本闸门缺口原因掩码();
        }
        if (来源缺口) {
            (void)写入基础节点指针(宿主, 特征_来源缺口(), 来源缺口, now);
        }
        (void)写入基础节点I64(宿主, 特征_补观察缺口状态(), 1, now);
        (void)写入基础节点I64(宿主, 特征_补观察缺失原因(), 合并缺口原因掩码, now);
        (void)写入基础节点I64(
            宿主,
            特征_质量缺口状态(),
            (合并缺口原因掩码 & 映射缺口原因_来源材料不可交付) != 0
                ? 观察质量缺口状态_存在
                : 观察质量缺口状态_不存在,
            now);
    }
    ...
    inline std::optional<结构_外设观察报告队列项> 读取近组最新正式外设观察报告(
        const std::string& 外设ID,
        枚举_外设观察报告类型 报告类型) noexcept;
    ...
    // 功能：收束 C 到 E 同一性候选中的排他性冲突数量，不产生最终事实归属。
    inline I64 外设观察存在同一性候选排他性冲突数量(
        const 结构_外设观察存在确认方案& 方案) noexcept
    {
        I64 冲突数量 = std::max<I64>(0, 方案.冲突数量);
        std::vector<存在节点类*> 已映射目标集合{};
        for (const auto& 项 : 方案.项集合) {
            if (项.方案类型 != 外设观察存在候选确认方案_合并
                || 项.允许提交状态 <= 0
                || !项.目标已知存在) {
    ...
    // 功能：在观察内部以治理闭环识别当前材料，返回已有存在指针或空指针。
    inline 存在节点类* 被动识别外设观察材料_内部治理(
        场景节点类* 输入参数场景,
        基础信息节点类* 目标宿主,
        场景节点类* 输出结果场景,
        结构_被动识别外设观察材料结果* 输出结果,
        bool 只取中间层近组最新材料 = false) noexcept
    {
        结构_被动识别外设观察材料结果 结果{};
        结果.已运行 = true;

        const auto 报告可选 = 只取中间层近组最新材料
            ? 读取近组最新正式外设观察报告(
                "双目相机/D455深度相机",
                枚举_外设观察报告类型::逐簇识别报告)
            : 读取指定或最新正式外设观察报告(
                ...
                "双目相机/D455深度相机",
                枚举_外设观察报告类型::逐簇识别报告);
        结果.来源报告存在 = 报告可选.has_value();
        if (报告可选.has_value()) {
            (void)保护D455短期观察材料页(
                *报告可选,
                D455短期材料页观察治理保护毫秒);
        }
        (void)补写已完成体素父基础颜色事实_由候选包集合(结构体_时间戳::当前_微秒());
        const auto 质量判定 = 判定自我侧观察材料质量(报告可选);
        结果.材料可进入识别 = 质量判定.可进入识别方法;
        结果.材料可交付观察方法 = 质量判定.可交付观察方法材料;

        if (!报告可选.has_value() || !结果.材料可进入识别) {
            结果.同一性状态 = 外设观察存在自我存在同一性状态_证据不足;
            结果.归属状态 = 外设观察存在自我归属状态_证据不足;
            if (输出结果) *输出结果 = 结果;
            return nullptr;
        ...
        结果.报告ID = static_cast<I64>(报告可选->报告ID);
        结果.候选簇数量 = static_cast<I64>(报告可选->观察像素簇集合.size());
        结果.上游验证状态 = 计算外设逐簇报告候选验证状态(*报告可选);
        const auto 已知集合 = 读取当前场景已确认存在集合(
            目标宿主,
            输入参数场景,
            输出结果场景);
        const auto 方案 = 构造外设观察存在确认方案(
            *报告可选,
            结果.上游验证状态 == 外设观察候选验证状态_已验证,
            已知集合,
            结果.材料可交付观察方法);

        const I64 同一性候选冲突数量 = 外设观察存在同一性候选排他性冲突数量(方案);
        结果.同一性状态 = 外设观察存在聚合同一性状态(方案);
        结果.同一性评分 = 外设观察存在最高同一性评分(方案);
        结果.归属状态 = 外设观察存在聚合归属状态(方案);
        结果.新建数量 = 方案.新建数量;
        结果.合并数量 = 方案.合并数量;
        结果.冲突数量 = 同一性候选冲突数量;
        结果.证据不足数量 = 方案.证据不足数量;
        ...
        存在节点类* 唯一存在 = nullptr;
        bool 有未命中或新建 = false;
        bool 有冲突或证据不足 = 同一性候选冲突数量 > 0;
        for (const auto& 项 : 方案.项集合) {
            const I64 项同一性状态 = 外设观察存在同一性状态_由确认方案项(项);
            if (项同一性状态 == 外设观察存在自我存在同一性状态_冲突
                || 项同一性状态 == 外设观察存在自我存在同一性状态_证据不足) {
                有冲突或证据不足 = true;
                continue;
            }
            if (项同一性状态 == 外设观察存在自我存在同一性状态_未命中已知存在) {
                有未命中或新建 = true;
                continue;
            }
            if (项同一性状态 != 外设观察存在自我存在同一性状态_已同一
                || !项.目标已知存在) {
                continue;
            }
            if (唯一存在 && 唯一存在 != 项.目标已知存在) {
                有冲突或证据不足 = true;
                continue;
            }
            唯一存在 = 项.目标已知存在;
    ...
    // 功能：把被动识别闭环的结构化结果写入运行宿主。
    inline void 写入被动识别外设观察材料摘要(
        基础信息节点类* 宿主,
        const 结构_被动识别外设观察材料结果& 结果,
        时间戳 now,
        const bool 允许P12主模型写入) noexcept
    {
        if (!宿主 || !结果.已运行) return;
        (void)写入基础节点I64(宿主, 特征_外设观察报告ID(), 结果.报告ID, now);
        (void)写入基础节点I64(宿主, 特征_外设观察验证候选簇数量(), 结果.候选簇数量, now);
        (void)写入基础节点I64(宿主, 特征_外设像素簇候选验证状态(), 结果.上游验证状态, now);
        (void)写入基础节点I64(宿主, 特征_外设观察存在_自我存在同一性状态(), 结果.同一性状态, now);
        (void)写入基础节点I64(宿主, 特征_外设观察存在_自我存在同一性评分(), 结果.同一性评分, now);
        (void)写入基础节点I64(宿主, 特征_外设观察存在自我归属状态(), 结果.归属状态, now);
        (void)写入基础节点I64(宿主, 特征_外设观察存在候选确认新建数量(), 结果.新建数量, now);
        (void)写入基础节点I64(宿主, 特征_外设观察存在候选确认合并数量(), 结果.合并数量, now);
        (void)写入基础节点I64(宿主, 特征_外设观察存在候选确认冲突数量(), 结果.冲突数量, now);
        (void)写入基础节点I64(宿主, 特征_外设观察存在候选确认证据不足数量(), 结果.证据不足数量, now);
        (void)写入基础节点I64(宿主, 特征_外设观察存在候选确认可提交数量(), 结果.可提交数量, now);
        写入P11结构化缺口摘要(
            宿主,
            被动识别观察闸门原因转P11映射缺口原因(
                被动识别观察写入闸门阻断原因掩码(结果)),
            0,
            now);
        if (结果.识别存在) {
            (void)写入基础节点指针(宿主, 特征_目标已确认观察存在(), 结果.识别存在, now);
            (void)写入基础节点指针(宿主, 特征_外设观察存在归属目标(), 结果.识别存在, now);
        }
        写入P12体素融合输入组只读摘要(宿主, 结果, now, 允许P12主模型写入);
    }

    // 功能：把共享关联外设材料输入投影为既有运行摘要特征。
    inline void 写入共享关联外设材料输入摘要(
        基础信息节点类* 宿主,
        const std::optional<结构_共享关联外设材料输入>& 输入可选,
        时间戳 now) noexcept
    {
        if (!宿主 || !输入可选.has_value()) return;
        const auto& 输入 = *输入可选;
        const std::size_t 可观测单位数量 = std::max(
            std::max(输入.空间候选句柄集.size(), 输入.感兴趣区域句柄集.size()),
            std::max(输入.点集句柄集.size(), std::max(输入.彩色轮廓局部图句柄集.size(), 输入.深度轮廓局部图句柄集.size())));
        (void)写入基础节点I64(宿主, 特征_外设观察报告ID(), static_cast<I64>(输入.来源报告ID), now);
        (void)写入基础节点I64(
            宿主,
            特征_当前观察范围有效可观测单位数量(),
            static_cast<I64>(可观测单位数量),
            now);
        (void)写入基础节点I64(
            宿主,
            特征_补观察缺口状态(),
        ...
        (void)写入基础节点I64(
            宿主,
            特征_质量缺口状态(),
            输入.缺口原因.empty() ? 观察质量缺口状态_不存在 : 观察质量缺口状态_存在,
            now);
    }
        ...
        const 双目相机本能适配器::调用结果& 来源) noexcept
    {
        ...
        结果.宽度 = 来源.宽度;
        结果.高度 = 来源.高度;
        结果.水平视野角毫度 = static_cast<I64>(来源.水平视野角毫度);
        结果.垂直视野角毫度 = static_cast<I64>(来源.垂直视野角毫度);
        结果.视野参数状态 = static_cast<I64>(来源.视野参数状态);
        ...
        const char* 输出特征名 = nullptr) noexcept
    {
        if (!结果.成功) {
            ...
            简要 << "双目相机本能方法结果"
                ...
                << " | 成功=0"
                << " | 相机已打开=" << (结果.相机已打开 ? 1 : 0)
                << " | 失败原因=" << 语素集.安全获取词(结果.失败原因)
                << " | 消息=" << 结果.消息
                << " | 目标外设=" << 基础节点日志文本(reinterpret_cast<基础信息节点类*>(相机存在))
                << " | 目标宿主=" << 基础节点日志文本(目标宿主)
                << " | 输出特征=" << (输出特征名 ? 输出特征名 : 语素集.安全获取词(输出特征))
    ...
    // 功能：把双目相机视野参数写入指定宿主的观察摘要。
    inline void 写入双目相机视野参数摘要(
        基础信息节点类* 宿主,
        const 结构_双目相机调用结果& 结果,
        时间戳 now) noexcept
    {
        if (!宿主) return;
        (void)写入基础节点I64(宿主, 特征_相机水平视野角毫度(), 结果.水平视野角毫度, now);
        (void)写入基础节点I64(宿主, 特征_相机垂直视野角毫度(), 结果.垂直视野角毫度, now);
        (void)写入基础节点I64(宿主, 特征_相机视野参数状态(), 结果.视野参数状态, now);
    }
    ...
    // 功能：只从中间层近组队列选择最新正式材料。
    inline std::optional<结构_外设观察报告队列项> 读取近组最新正式外设观察报告(
        const std::string& 外设ID,
        枚举_外设观察报告类型 报告类型) noexcept
    {
        auto 队列视图 = 读取外设观察报告队列视图(外设ID, 报告类型, false);
        ...
        枚举_外设观察报告类型 报告类型) noexcept
    {
        ...
        auto 队列视图 = 读取外设观察报告队列视图(外设ID, 报告类型, false);
        auto 选择近组正式报告 = [&]() -> std::optional<结构_外设观察报告队列项> {
            for (auto 迭代器 = 队列视图.rbegin(); 迭代器 != 队列视图.rend(); ++迭代器) {
                if (外设观察报告匹配正式读取口径(*迭代器, 外设ID, 报告类型)) {
                    return *迭代器;
                }
        ...
        if (有指定报告 && 指定报告ID > 0) {
            const auto 指定报告ID_U64 = static_cast<std::uint64_t>(指定报告ID);
            auto 指定近组报告 = std::find_if(
                队列视图.begin(),
                队列视图.end(),
                [指定报告ID_U64](const 结构_外设观察报告队列项& 报告) noexcept {
                    return 报告.报告ID == 指定报告ID_U64;
                });
            const bool 指定报告在近组 = 指定近组报告 != 队列视图.end();
            const bool 指定报告正式可用 = 指定报告在近组
                && 外设观察报告匹配正式读取口径(*指定近组报告, 外设ID, 报告类型);
            if (指定报告正式可用) {
                return *指定近组报告;
            }
            auto 可用近组正式报告 = 选择近组正式报告();
            {
                std::ostringstream 输出;
                输出 << "外设正式报告读取按近组拒绝指定报告"
                    << " | 指定报告ID=" << 指定报告ID
                    << " | 指定报告在近组=" << (指定报告在近组 ? 1 : 0)
                    << " | 指定报告正式可用=" << (指定报告正式可用 ? 1 : 0)
                    << " | 可用近组报告ID=" << (可用近组正式报告.has_value() ? 可用近组正式报告->报告ID : 0)
                    << " | 使用报告ID=0"
                    << " | 近组报告数=" << 队列视图.size()
                    << " | 只取中间层近组=1"
                    << " | 不跨帧回退旧材料=1"
        ...
        const 结构_外设观察报告队列项& 报告) noexcept
    {
        if (!报告.采集成功
            ...
            || !解析D455观察材料句柄(报告.空间候选队列句柄).成功
            || !解析D455观察材料句柄(报告.像素归属账本句柄).成功) {
        ...
        for (const auto& 簇 : 报告.观察像素簇集合) {
            const bool 有像素材料 =
                ...
                || (!簇.ROI句柄.empty() && 解析D455观察材料句柄(簇.ROI句柄).成功)
                || (!簇.点集句柄.empty() && 解析D455观察材料句柄(簇.点集句柄).成功);
            const bool 有像素归属材料 =
                !簇.像素归属验证材料句柄.empty()
                && 解析D455观察材料句柄(簇.像素归属验证材料句柄).成功;
            const bool 有空间材料 =
                !簇.空间候选句柄.empty()
                && 解析D455观察材料句柄(簇.空间候选句柄).成功
                && 簇.来源空间候选ID >= 0
                && 簇.深度有效率 > 0
                && 簇.空间坐标有效率 > 0;
            const bool 投影有效 =
        ...
        结构_双目相机调用结果& 结果) noexcept
    {
        ...
        if (读取观察摘要I64(目标宿主, 输入参数场景, 输出结果场景, 特征_相机水平视野角毫度(), 值)) {
            结果.水平视野角毫度 = std::max<I64>(0, 值);
        }
        if (读取观察摘要I64(目标宿主, 输入参数场景, 输出结果场景, 特征_相机垂直视野角毫度(), 值)) {
            结果.垂直视野角毫度 = std::max<I64>(0, 值);
        }
        if (读取观察摘要I64(目标宿主, 输入参数场景, 输出结果场景, 特征_相机视野参数状态(), 值)) {
            结果.视野参数状态 = std::max<I64>(0, 值);
        }
    ...
    // 功能：返回观察发现存在必须写入的自我所在场景子链宿主。
    inline 基础信息节点类* 取观察发现存在写入宿主() noexcept
    {
        return reinterpret_cast<基础信息节点类*>(世界树.取或创建自我现实场景());
    }

    // 功能：只读返回当前自我所在场景宿主，不隐式创建结构。
    inline 基础信息节点类* 读取观察发现存在写入宿主() noexcept
    {
        return reinterpret_cast<基础信息节点类*>(世界树.自我所在场景);
    }
    ...
    {
        (void)宿主;
        auto* 场景宿主 = 取观察发现存在写入宿主();
        if (!场景宿主) return nullptr;
        auto* 名称 = 语素集.添加信息入口词(
            std::string("已确认观察存在.") + std::to_string(来源候选编号),
            枚举_信息入口类型::存在实例入口);
        return 世界树.取或创建子存在_按名称类型(
            场景宿主,
            名称,
            类型_已确认观察存在());
    }
        ...
        时间戳 now) noexcept
    {
        ...
        I64 写入数量 = 0;
        auto 计数写入I64 = [&](const 语素入口节点类* 特征类型, I64 值) noexcept {
            if (写入基础节点I64(节点, 特征类型, 值, now)) {
                ++写入数量;
            }
        };
        计数写入I64(特征_中心空间坐标X(), 假设.候选.中心X);
        计数写入I64(特征_中心空间坐标Y(), 假设.候选.中心Y);
        计数写入I64(特征_中心空间坐标Z(), 假设.候选.中心Z);
        计数写入I64(特征_范围坐标AABB最小X(), 假设.候选.范围最小X);
        计数写入I64(特征_范围坐标AABB最大X(), 假设.候选.范围最大X);
        计数写入I64(特征_范围坐标AABB最小Y(), 假设.候选.范围最小Y);
        计数写入I64(特征_范围坐标AABB最大Y(), 假设.候选.范围最大Y);
        计数写入I64(特征_范围坐标AABB最小Z(), 假设.候选.范围最小Z);
        计数写入I64(特征_范围坐标AABB最大Z(), 假设.候选.范围最大Z);
        计数写入I64(特征_假设尺寸X(), 假设.尺寸X);
        计数写入I64(特征_假设尺寸Y(), 假设.尺寸Y);
        计数写入I64(特征_假设尺寸Z(), 假设.尺寸Z);
        if (簇) {
            if (写入观察簇到存在节点允许轮廓(节点, *簇, now)) {
                写入数量 += 2;
            }
            if (写入基础节点UTF8句柄VecU(节点, 特征_彩图(), 簇->彩色轮廓局部图句柄, now)) {
                ++写入数量;
            }
            if (写入基础节点UTF8句柄VecU(节点, 特征_深度图(), 簇->深度轮廓局部图句柄, now)) {
                ++写入数量;
            }
        }
        (void)验证;
    ...
    // 功能：创建并返回自我内部世界，作为内部治理记录的承载场景。
    inline 场景节点类* 取或创建自我内部世界_外设治理(时间戳 now) noexcept
    {
        auto* 自我存在 = 世界树.取或创建自我存在();
        return 自我存在
            ? 世界树.取或创建存在内部世界(自我存在, 名称_存在内部世界())
            : nullptr;
    }

    // 功能：创建并返回观察内部治理记录节点。
    inline 存在节点类* 取或创建观察内部治理记录(时间戳 now) noexcept
    {
        auto* 内部世界 = 取或创建自我内部世界_外设治理(now);
        auto* 内部宿主 = reinterpret_cast<基础信息节点类*>(内部世界);
        return 内部宿主
            ? 世界树.取或创建子存在_按类型并按特征I64(
                内部宿主,
                类型_观察内部治理记录(),
    ...
    {
        auto* 状态特征 = 记录宿主
            ? 世界树.取或创建子特征_按类型(记录宿主, 特征_观察内部治理记录状态())
            : nullptr;
        if (!方法首节点 || !内部世界 || !记录宿主 || !状态特征) {
            return nullptr;
        }
        ...
        auto* 动态 = 世界树.创建方法动作动态(
            ...
            now,
            记录状态 == 观察内部治理记录状态_已生成,
            记录状态 == 观察内部治理记录状态_已生成 ? 0 : -1,
            输入参数场景 ? 输入参数场景 : 内部世界,
            输出结果场景 ? 输出结果场景 : 内部世界,
            初始状态,
            结果状态);
        if (动态 && 来源动作动态) {
            (void)世界树.追加来源低层动态(动态, 来源动作动态);
        }
        if (动态) {
            auto* 动态宿主 = reinterpret_cast<基础信息节点类*>(动态);
            (void)写入基础节点指针(动态宿主, 特征_当前方法运行存在(), 运行存在, now);
            (void)写入基础节点指针(动态宿主, 特征_来源动作动态(), 来源动作动态, now);
        }
        return 动态;
    }

    // 功能：把观察本轮识别归属结果写入已确认观察存在，并累计结构化结果数量。
    inline 结构_观察内部治理写入结果 写入观察识别归属结果(
        基础信息节点类* 目标宿主,
        const 结构_被动识别外设观察材料结果& 被动识别结果,
        动态节点类* 来源动作动态,
        时间戳 now) noexcept
    {
        结构_观察内部治理写入结果 结果{};
        结果.记录状态 = 被动识别结果.已运行
            ? 观察内部治理记录状态_已生成
            : 观察内部治理记录状态_条件不足;
        if (!目标宿主 || !被动识别结果满足观察写入收束闸门(被动识别结果)) {
            return 结果;
        }

        const bool 允许观察创建新存在 =
            被动识别结果.同一性状态 == 外设观察存在自我存在同一性状态_未命中已知存在
            && 被动识别结果.归属状态 == 外设观察存在自我归属状态_待建立;

        for (const auto& 项 : 被动识别结果.确认方案.项集合) {
            ...
            if (项.方案类型 == 外设观察存在候选确认方案_合并 && 项.目标已知存在) {
                观察存在 = 项.目标已知存在;
                本项更新 = true;
            } else if (项.方案类型 == 外设观察存在候选确认方案_新建 && 允许观察创建新存在) {
                const I64 创建键 = 项.来源候选簇ID != 0
                    ? 项.来源候选簇ID
                    : std::max<I64>(0, 项.来源空间候选编号);
            ...
            计数写入I64(特征_外设观察报告ID(), 被动识别结果.报告ID);
            计数写入I64(特征_外设观察像素簇ID(), 项.来源候选簇ID);
            计数写入I64(特征_来源空间候选编号(), 项.来源空间候选编号);
            计数写入I64(特征_观察存在发现状态(), 观察存在发现状态_已发现);
            计数写入I64(特征_观察存在与当前场景关联状态(), 1);
            计数写入I64(特征_存在当前特征状态(), 存在当前特征状态_已更新);
            计数写入I64(特征_外设观察存在_自我存在同一性状态(), 外设观察存在同一性状态_由确认方案项(项));
            计数写入I64(特征_外设观察存在自我归属状态(), 外设观察存在自我归属状态_已归属);
            本项写入数量 += 写入观察候选C收束状态(观察节点, 项, now);
            if (来源动作动态 && 写入基础节点指针(观察节点, 特征_动作动态(), 来源动作动态, now)) {
                ++本项写入数量;
            }
            结果.写入特征数量 += 本项写入数量;
            ++结果.处理项数量;
    ...
    // 功能：把观察内部治理结构化结果写入自我内部世界。
    inline void 写入观察内部治理记录(
        方法类::节点类* 方法首节点,
        场景节点类* 输入参数场景,
        场景节点类* 输出结果场景,
        存在节点类* 运行存在,
        ...
        时间戳 now) noexcept
    {
        auto* 记录 = 取或创建观察内部治理记录(now);
        auto* 记录宿主 = reinterpret_cast<基础信息节点类*>(记录);
        auto* 内部世界 = 取或创建自我内部世界_外设治理(now);
        if (!记录宿主 || !内部世界) {
            治理结果.记录状态 = 观察内部治理记录状态_条件不足;
            return;
        }
        (void)写入基础节点I64(记录宿主, 特征_开始时间(), static_cast<I64>(now), now);
        (void)写入基础节点I64(记录宿主, 特征_观察内部治理记录状态(), 治理结果.记录状态, now);
        (void)写入基础节点I64(记录宿主, 特征_外设观察报告ID(), 被动识别结果.报告ID, now);
        (void)写入基础节点I64(记录宿主, 特征_外设观察验证候选簇数量(), 被动识别结果.候选簇数量, now);
        (void)写入基础节点I64(记录宿主, 特征_外设观察存在_自我存在同一性状态(), 被动识别结果.同一性状态, now);
        (void)写入基础节点I64(记录宿主, 特征_外设观察存在自我归属状态(), 被动识别结果.归属状态, now);
        (void)写入基础节点I64(记录宿主, 特征_外设观察存在候选确认新建数量(), 被动识别结果.新建数量, now);
        (void)写入基础节点I64(记录宿主, 特征_外设观察存在候选确认合并数量(), 被动识别结果.合并数量, now);
        (void)写入基础节点I64(记录宿主, 特征_外设观察存在候选确认冲突数量(), 被动识别结果.冲突数量, now);
        (void)写入基础节点I64(记录宿主, 特征_外设观察存在候选确认证据不足数量(), 被动识别结果.证据不足数量, now);
        (void)写入基础节点I64(记录宿主, 特征_外设观察存在候选确认可提交数量(), 被动识别结果.可提交数量, now);
        写入P11结构化缺口摘要(
            记录宿主,
            被动识别观察闸门原因转P11映射缺口原因(
                被动识别观察写入闸门阻断原因掩码(被动识别结果)),
            0,
            now);
        (void)写入基础节点I64(记录宿主, 特征_观察新建存在数量(), 治理结果.新建存在数量, now);
        (void)写入基础节点I64(记录宿主, 特征_观察更新已有存在数量(), 治理结果.更新已有存在数量, now);
        (void)写入基础节点I64(记录宿主, 特征_观察写入特征数量(), 治理结果.写入特征数量, now);
        (void)写入基础节点I64(记录宿主, 特征_观察治理处理项数量(), 治理结果.处理项数量, now);
        (void)写入基础节点I64(记录宿主, 特征_观察治理写入失败数量(), 治理结果.写入失败数量, now);
        (void)写入基础节点指针(记录宿主, 特征_当前方法运行存在(), 运行存在, now);
        (void)写入基础节点指针(记录宿主, 特征_来源动作动态(), 来源动作动态, now);
        治理结果.被动动作动态 = 创建观察内部治理被动动作动态(
            方法首节点,
            内部世界,
            记录宿主,
            治理结果.记录状态,
            ...
            来源动作动态,
            now);
        (void)写入基础节点指针(记录宿主, 特征_动作动态(), 治理结果.被动动作动态, now);
    }
        ...
        时间戳 now) noexcept
    {
        ...
        if (auto* 内部节点 = reinterpret_cast<基础信息节点类*>(上下文.内部世界)) {
            上下文.内外接口 = 世界树.查找子存在_按类型(内部节点, 类型_存在内外接口());
    ...
    // 功能：判断内部世界子存在是否具备生成局部体素模型的空间输入。
    inline bool 内部世界子存在局部体素输入可用(const 结构_内部世界上下文& 上下文) noexcept
    {
        return 上下文.目标存在
            && 上下文.内部世界
            && 上下文.子候选
            && 上下文.局部轮廓材料可回查状态 == 内部世界局部轮廓材料可回查状态_可回查
            && 上下文.宽度 > 0
            && 上下文.高度 > 0
            && 上下文.最大Z >= 上下文.最小Z;
    }

    struct 结构_内部世界子体素写入结果 {
        bool 成功 = false;
        I64 局部体素边长 = 0;
        I64 占据体素数量 = 0;
        I64 体素模型版本 = 0;
    ...
    // 功能：提交入口裁决后为内部世界子存在写入局部正立方体体素模型。
    inline 结构_内部世界子体素写入结果 写入内部世界子存在局部体素模型(
        存在节点类* 子存在,
        ...
        时间戳 now)
    {
        结构_内部世界子体素写入结果 结果{};
        auto* 子节点 = reinterpret_cast<基础信息节点类*>(子存在);
        if (!子节点 || !内部世界子存在局部体素输入可用(上下文)) {
            return 结果;
        }

        constexpr std::uint32_t 最小体素边长_mm = 25;
        constexpr std::uint64_t 最大子存在体素数 = 2000000;
        const auto 宽度体素 = 观察簇空间范围体素维度(0, 上下文.宽度, 最小体素边长_mm);
        const auto 高度体素 = 观察簇空间范围体素维度(0, 上下文.高度, 最小体素边长_mm);
        const auto 深度体素 = 观察簇空间范围体素维度(0, std::max<I64>(1, 上下文.深度), 最小体素边长_mm);
        const auto 最长维度 = (std::max)({ 宽度体素, 高度体素, 深度体素 });
        if (宽度体素 == 0 || 高度体素 == 0 || 深度体素 == 0 || 最长维度 == 0) {
            return 结果;
        }
        ...
        const auto 包围盒边长64 = 特征类::三维体素最终边长(*细分层数);
        if (包围盒边长64 < 3
            || 包围盒边长64 > static_cast<std::uint64_t>((std::numeric_limits<std::uint32_t>::max)())
            || 三维体素总数(包围盒边长64) > 最大子存在体素数) {
            return 结果;
        }

        const auto 包围盒边长 = static_cast<std::uint32_t>(包围盒边长64);
        auto 占据位块 = 特征类::创建三维体素占据位块(*细分层数);
        if (占据位块.empty()) {
            return 结果;
        }

        const auto 有效边长 = 包围盒边长 - 2;
        auto 映射有效维度 = [&](std::uint32_t 维度) noexcept -> std::uint32_t {
            if (维度 == 0 || 最长维度 == 0 || 有效边长 == 0) return 0;
            const auto 比例 = static_cast<long double>(维度) / static_cast<long double>(最长维度);
            const auto 映射 = std::llround(比例 * static_cast<long double>(有效边长));
            if (映射 <= 0) return 1;
            return std::min<std::uint32_t>(有效边长, static_cast<std::uint32_t>(映射));
        };

        const auto 映射宽度 = 映射有效维度(宽度体素);
        const auto 映射高度 = 映射有效维度(高度体素);
        const auto 映射深度 = 映射有效维度(深度体素);
        if (映射宽度 == 0 || 映射高度 == 0 || 映射深度 == 0) {
            return 结果;
        }

        for (std::uint32_t z = 0; z < 映射深度; ++z) {
            for (std::uint32_t y = 0; y < 映射高度; ++y) {
                for (std::uint32_t x = 0; x < 映射宽度; ++x) {
                    if (特征类::写入三维体素占据位(
                            占据位块,
                            *细分层数,
                            x + 1,
        ...
        auto* 体素特征 = 世界树.取或创建子特征_按类型(子节点, 特征_三维体素模型());
        if (!体素特征) {
            return 结果;
        }
        ...
        const bool 可压缩版本 =
            上下文.外设观察报告ID > 0
            && 上下文.外设观察报告ID <= 9000000000000LL
            && 上下文.来源候选编号 >= 0
            && 上下文.来源候选编号 <= 999999LL;
        结果.体素模型版本 = 可压缩版本
            ? 上下文.外设观察报告ID * 1000000LL + 上下文.来源候选编号
            : static_cast<I64>(now);
        结果.局部体素边长 = static_cast<I64>(包围盒边长);
        (void)写入基础节点I64(子节点, 特征_体素模型版本(), 结果.体素模型版本, now);
        结果.成功 = true;
        return 结果;
    }
    ...
    inline 存在节点类* 取或创建内部世界子存在(结构_内部世界上下文& 上下文, 时间戳 now) noexcept
    {
        ...
        (void)写入基础节点I64(节点, 特征_局部边界框宽度(), 上下文.投影宽度, now);
        (void)写入基础节点I64(节点, 特征_局部边界框高度(), 上下文.投影高度, now);
        (void)写入基础节点I64(节点, 特征_空间坐标单位毫米(), 1, now);
        (void)写入基础节点I64(节点, 特征_局部坐标原点X(), 上下文.最小X, now);
        (void)写入基础节点I64(节点, 特征_局部坐标原点Y(), 上下文.最小Y, now);
        (void)写入基础节点I64(节点, 特征_局部坐标原点Z(), 上下文.最小Z, now);
    ...
    inline 结构_场景复现上下文 读取场景复现上下文(基础信息节点类* 宿主) noexcept
    {
        ...
        上下文.水平视野角毫度 = 读取I64或0(宿主, 特征_相机水平视野角毫度());
        上下文.垂直视野角毫度 = 读取I64或0(宿主, 特征_相机垂直视野角毫度());
        上下文.视野参数状态 = 读取I64或0(宿主, 特征_相机视野参数状态());
        ...
        时间戳 now) noexcept
    {
        ...
        (void)写入基础节点I64(节点, 特征_相机水平视野角毫度(), 上下文.水平视野角毫度, now);
        (void)写入基础节点I64(节点, 特征_相机垂直视野角毫度(), 上下文.垂直视野角毫度, now);
        (void)写入基础节点I64(节点, 特征_相机视野参数状态(), 上下文.视野参数状态, now);
...
export namespace 自我动作实现模块::外设模块 {
        ...
        时间戳 now) noexcept
    {
        ...
        if (auto* 结果根 = 方法规格根(方法首节点, 特征_结果表(), now)) {
            ...
            ok = 取或创建子特征(宿主, 特征_相机水平视野角毫度()) && ok;
            ok = 取或创建子特征(宿主, 特征_相机垂直视野角毫度()) && ok;
            ok = 取或创建子特征(宿主, 特征_相机视野参数状态()) && ok;
        ...
        时间戳 now) noexcept
    {
        ...
        ok = 方法类::声明条件特征(方法首节点, 特征_场景体素先验版本(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_场景体素先验坐标系版本(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_场景体素先验可用状态(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉先验匹配评分(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉自由空间冲突候选数量(), false, now) && ok;
        ok = 登记P11共享关联判断结果特征(方法首节点, nullptr, now, true) && ok;
        if (auto* 结果根 = 方法规格根(方法首节点, 特征_结果表(), now)) {
            auto* 宿主 = reinterpret_cast<基础信息节点类*>(结果根);
            ...
            ok = 取或创建子特征(宿主, 特征_场景体素先验版本()) && ok;
            ok = 取或创建子特征(宿主, 特征_场景体素先验坐标系版本()) && ok;
            ok = 取或创建子特征(宿主, 特征_场景体素先验可用状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉先验匹配状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉先验匹配数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉先验匹配评分()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉深度一致评分()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉自由空间冲突候选数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉信息缺口数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉遮挡候选数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉深度缺失数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉证据不足数量()) && ok;
            ...
            ok = 取或创建子特征(宿主, 特征_动作动态()) && ok;
            ok = 取或创建子特征(宿主, 特征_失败原因()) && ok;
            ok = 登记P11共享关联判断结果特征(方法首节点, 宿主, now, false) && ok;
        }
        ...
        时间戳 now) noexcept
    {
        ...
        ok = 方法类::声明条件特征(方法首节点, 特征_场景体素先验坐标系版本(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_场景体素先验可用状态(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉先验匹配状态(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉先验匹配数量(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉先验匹配评分(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉深度一致评分(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉自由空间冲突候选数量(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉信息缺口数量(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视野外证据数量(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉遮挡候选数量(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉深度缺失数量(), false, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_视觉证据不足数量(), false, now) && ok;
        ok = 登记P11共享关联判断结果特征(方法首节点, nullptr, now, true) && ok;
        if (auto* 结果根 = 方法规格根(方法首节点, 特征_结果表(), now)) {
            auto* 宿主 = reinterpret_cast<基础信息节点类*>(结果根);
            ok = 取或创建子特征(宿主, 特征_目标存在()) && ok;
            ...
            ok = 取或创建子特征(宿主, 特征_视觉自由空间冲突候选数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉信息缺口数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视野外证据数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉遮挡候选数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉深度缺失数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉证据不足数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_跟踪先验预计范围状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_跟踪丢失解释状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_失败原因()) && ok;
            ok = 登记P11共享关联判断结果特征(方法首节点, 宿主, now, false) && ok;
        }
        ...
        ok = 确保方法结果能力I64(方法首节点, 特征_跟踪先验预计范围状态(), 跟踪先验预计范围状态_已建立) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_跟踪先验预计范围状态(), 跟踪先验预计范围状态_条件不足) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_跟踪丢失解释状态(), 跟踪丢失解释状态_无丢失) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_跟踪丢失解释状态(), 跟踪丢失解释状态_遮挡) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_跟踪丢失解释状态(), 跟踪丢失解释状态_自由空间冲突) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_跟踪丢失解释状态(), 跟踪丢失解释状态_深度缺失) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_跟踪丢失解释状态(), 跟踪丢失解释状态_证据不足) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_跟踪丢失解释状态(), 跟踪丢失解释状态_视野外) && ok;
        return ok;
    }
        ...
        时间戳 now) noexcept
    {
        ...
        if (auto* 结果根 = 方法规格根(方法首节点, 特征_结果表(), now)) {
            ...
            ok = 取或创建子特征(宿主, 特征_视觉信息缺口数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_视觉证据不足数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_先验版本可接受状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_先验版本闸门缺口原因掩码()) && ok;
            ok = 取或创建子特征(宿主, 特征_当前观察范围有效可观测单位数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_已稳定对应存在可观测单位数量()) && ok;
        ...
        ok = 确保方法结果能力I64(方法首节点, 特征_先验版本可接受状态(), 先验版本可接受状态_可接受) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_已识别区域扫描入账状态(), 已知存在当前帧扫描状态_已生成) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_扫描可启动状态(), 1) && ok;
        ...
        时间戳 now) noexcept
    {
        ...
        if (auto* 结果根 = 方法规格根(方法首节点, 特征_结果表(), now)) {
            ...
            ok = 取或创建子特征(宿主, 特征_体素父基础颜色RGBA()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素父基础颜色像素数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素父基础颜色事实状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素颜色来源观察证据ID()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素颜色来源基准体素版本()) && ok;
            ok = 取或创建子特征(宿主, 特征_动作动态()) && ok;
            ok = 取或创建子特征(宿主, 特征_失败原因()) && ok;
        }
        return ok;
        ...
        时间戳 now) noexcept
    {
        if (!方法首节点 || !方法存在) return false;
        bool ok = true;
        ok = 声明形参规格(方法首节点, 特征_当前观察场景(), 值类型_场景指针(), 值_来源_输入条件包(), true, now) && ok;
        ok = 方法类::声明条件特征(方法首节点, 特征_当前观察场景(), now) && ok;
        if (auto* 结果根 = 方法规格根(方法首节点, 特征_结果表(), now)) {
            auto* 宿主 = reinterpret_cast<基础信息节点类*>(结果根);
            ok = 取或创建子特征(宿主, 特征_当前观察场景()) && ok;
            ok = 取或创建子特征(宿主, 特征_观察存在发现状态()) && ok;
            ...
            ok = 取或创建子特征(宿主, 特征_外设观察存在_自我存在同一性状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_外设观察存在自我归属状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_观察内部治理记录状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_观察新建存在数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_观察更新已有存在数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_观察写入特征数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_观察治理处理项数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_观察治理写入失败数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_动作动态()) && ok;
            ok = 取或创建子特征(宿主, 特征_失败原因()) && ok;
            ok = 登记P11共享关联判断结果特征(方法首节点, 宿主, now, false) && ok;
        }
        ok = 确保方法结果能力I64(方法首节点, 特征_观察存在发现状态(), 观察存在发现状态_已发现) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_存在当前特征状态(), 存在当前特征状态_已更新) && ok;
        ok = 确保方法结果能力I64(方法首节点, 特征_观察内部治理记录状态(), 观察内部治理记录状态_已生成) && ok;
        return ok;
    }
        ...
        时间戳 now) noexcept
    {
        ...
        if (auto* 结果根 = 方法规格根(方法首节点, 特征_结果表(), now)) {
            ...
            ok = 取或创建子特征(宿主, 特征_体素子平均颜色RGBA()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素子平均颜色像素数量()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素子平均颜色事实状态()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素颜色来源观察证据ID()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素颜色来源基准体素版本()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素子候选ID()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素局部子体素候选ID()) && ok;
            ok = 取或创建子特征(宿主, 特征_体素子候选映射状态()) && ok;
        }
        return ok;
    }
    ...
    // 功能：解析观察本能唯一业务形参当前观察场景。
    inline 基础信息节点类* 解析观察函数自我所在场景参数(
        场景节点类* 输入参数场景,
        基础信息节点类* 诊断宿主) noexcept
    {
        void* 指针 = nullptr;
        if (!读取输入参数指针(输入参数场景, 特征_当前观察场景(), 指针)) {
            return nullptr;
        }
        auto* 候选节点 = reinterpret_cast<基础信息节点类*>(指针);
        if (基础节点属于当前世界树(候选节点)
    ...
    inline 动态节点类* 写入双目相机I64事实与动态(
        ...
        存在节点类* 运行存在,
        时间戳 now,
        const 语素入口节点类* 动作语义覆盖 = nullptr) noexcept
    {
        ...
        I64 写入前值 = 0;
        const bool 有写入前值 = 读取基础节点I64(宿主, 特征类型, 写入前值);
        const bool 写入值变化 = 有写入前值 && 写入前值 != 值;
        ...
        auto* 结果状态 = 世界树.创建内部状态(
            ...
            now);
        动态节点类* 状态迁移动态 = 结果状态
            ? 世界树.状态记录后刷新动态(场景, 结果状态, now)
            : nullptr;
        if (auto* 状态迁移主信息 = 世界树.取动态主信息(状态迁移动态)) {
            if (状态迁移主信息->初始状态.指针) {
                初始状态 = 状态迁移主信息->初始状态.指针;
            }
            if (状态迁移主信息->结果状态.指针) {
                结果状态 = 状态迁移主信息->结果状态.指针;
            }
        }
        ...
        auto* 动态 = 世界树.创建方法动作动态(
            ...
            初始状态,
            结果状态);
        if (动态 && 状态迁移动态 && 动态 != 状态迁移动态) {
            (void)世界树.追加来源低层动态(动态, 状态迁移动态);
        }
        if (动态) {
            auto* 动态宿主 = reinterpret_cast<基础信息节点类*>(动态);
    ...
    // 功能：从运行结果读取本轮动作动态。
    inline 动态节点类* 读取运行结果动作动态(
        存在节点类* 运行结果) noexcept
    {
        void* 指针 = nullptr;
        auto* 宿主 = reinterpret_cast<基础信息节点类*>(运行结果);
        if (!宿主 || !读取基础节点指针(宿主, 特征_动作动态(), 指针)) {
            return nullptr;
        }
    ...
    // 功能：执行当前观察特征帧采集和写账。
    inline 存在节点类* 执行双目相机取得当前观察特征帧写账(
        方法类::节点类* 方法树锚点,
        场景节点类* 输入参数场景,
        场景节点类* 输出结果场景,
        const 语素入口节点类* 动作语义覆盖,
        const char* 诊断标签) noexcept
    {
        const auto now = 结构体_时间戳::当前_微秒();
        auto 环境 = 确保本能方法自身环境(
            方法树锚点,
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        if (!成功 && !结果.失败原因) {
            ...
            结果.消息 =
                "观察事实完备性条件不足"
                " | 观察事实完备状态=" + std::to_string(结果.观察事实完备状态)
                + " | 失败条件数量=" + std::to_string(结果.观察事实完备失败条件数量);
        }
        结果.成功 = 成功;
        auto* 动态 = 写入双目相机I64事实与动态(
            环境.方法首节点,
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        if (!成功 && !结果.失败原因) {
            ...
            结果.消息 =
                "观察帧质量条件不足"
                " | 质量可用状态=" + std::to_string(结果.质量可用状态)
                + " | 失败条件数量=" + std::to_string(结果.质量失败条件数量);
        }
        结果.成功 = 成功;
        auto* 动态 = 写入双目相机I64事实与动态(
            环境.方法首节点,
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        const auto 是安全证据搜索状态输出 = [&](const 语素入口节点类* 特征类型) noexcept {
            return 语素入口同一(特征类型, 特征_安全因果因素证据搜索状态())
                || 语素入口同一(特征类型, 特征_风险安全_运行影响部分证据搜索状态())
                || 语素入口同一(特征类型, 特征_风险安全_资源影响部分证据搜索状态())
                || 语素入口同一(特征类型, 特征_风险安全_权限影响部分证据搜索状态())
                || 语素入口同一(特征类型, 特征_风险安全_未知影响部分证据搜索状态());
        };
        ...
        auto 写搜索结果 = [&](基础信息节点类* 宿主) noexcept {
            ...
            if (!语素入口同一(输出搜索状态特征, 特征_安全因果因素证据搜索状态())) {
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        if (!目标存在) {
            ...
            约束.幂等键 = 目标存在->获取主键()
                ...
                + 目标特征类型->获取主键()
                + "|当前值类型="
                + std::to_string(static_cast<I64>(当前值快照.值类型))
                + "|当前I64值="
                + std::to_string(当前值快照.I64值)
                + "|当前值句柄="
                + 当前值快照.句柄
                + "|来源报告="
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        const auto 报告可选 = 读取指定或最新正式外设观察报告(
            ...
            枚举_外设观察报告类型::逐簇识别报告);
        const auto 质量判定 = 判定自我侧观察材料质量(报告可选);
        const auto 共享外设输入 = 报告可选.has_value()
            ? std::optional<结构_共享关联外设材料输入>(
                构造共享关联外设材料输入_由观察报告(*报告可选, nullptr))
            : std::nullopt;
        ...
        I64 场景体素先验版本 = 0;
        const bool 场景体素先验版本已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_场景体素先验版本(),
            场景体素先验版本);
        I64 场景体素先验坐标系版本 = 0;
        const bool 场景体素先验坐标系版本已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_场景体素先验坐标系版本(),
            场景体素先验坐标系版本);
        I64 场景体素先验可用状态 = 0;
        const bool 场景体素先验可用状态已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_场景体素先验可用状态(),
            场景体素先验可用状态);
        I64 视觉先验匹配数量 = 0;
        const bool 视觉先验匹配数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉先验匹配数量(),
            视觉先验匹配数量);
        I64 视觉先验匹配评分 = 0;
        const bool 视觉先验匹配评分已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉先验匹配评分(),
            视觉先验匹配评分);
        I64 视觉深度一致评分 = 0;
        const bool 视觉深度一致评分已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉深度一致评分(),
            视觉深度一致评分);
        I64 视觉自由空间冲突候选数量 = 0;
        const bool 视觉自由空间冲突候选数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉自由空间冲突候选数量(),
            视觉自由空间冲突候选数量);
        I64 视觉信息缺口数量 = 0;
        const bool 视觉信息缺口数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉信息缺口数量(),
            视觉信息缺口数量);
        I64 视觉遮挡候选数量 = 0;
        const bool 视觉遮挡候选数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉遮挡候选数量(),
            视觉遮挡候选数量);
        I64 视觉深度缺失数量 = 0;
        const bool 视觉深度缺失数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉深度缺失数量(),
            视觉深度缺失数量);
        I64 视觉证据不足数量 = 0;
        const bool 视觉证据不足数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉证据不足数量(),
        ...
        const bool 视觉先验字段已读 =
            ...
            || 视觉深度缺失数量已读
            || 视觉证据不足数量已读;
        I64 视觉先验匹配状态 = 视觉先验匹配状态_未读取;
        if (视觉自由空间冲突候选数量已读 && 视觉自由空间冲突候选数量 > 0) {
            视觉先验匹配状态 = 视觉先验匹配状态_冲突;
        } else if ((视觉信息缺口数量已读 && 视觉信息缺口数量 > 0)
            || (视觉深度缺失数量已读 && 视觉深度缺失数量 > 0)
            || (视觉证据不足数量已读 && 视觉证据不足数量 > 0)) {
            视觉先验匹配状态 = 视觉先验匹配状态_证据不足;
        } else if ((视觉先验匹配数量已读 && 视觉先验匹配数量 > 0)
            || (视觉先验匹配评分已读 && 视觉先验匹配评分 > 0)) {
            视觉先验匹配状态 = 视觉先验匹配状态_已匹配;
        } else if (视觉先验字段已读) {
            视觉先验匹配状态 = 视觉先验匹配状态_无匹配;
        }
        ...
        if (!报告可选.has_value()) {
            ...
            结果.失败原因 = 值_执行缺口_当前方法条件不满足();
            结果.消息 = "识别未完成:C到E同一性候选存在排他性冲突";
            方案.确认状态 = 外设观察存在候选确认状态_冲突;
        } else {
        ...
        auto 写识别摘要 = [&](基础信息节点类* 宿主) noexcept {
            ...
            (void)写入基础节点I64(宿主, 特征_外设观察存在候选确认冲突数量(), 同一性候选冲突数量, now);
            ...
            (void)写入基础节点I64(宿主, 特征_场景体素先验版本(), 场景体素先验版本已读 ? 场景体素先验版本 : 0, now);
            (void)写入基础节点I64(宿主, 特征_场景体素先验坐标系版本(), 场景体素先验坐标系版本已读 ? 场景体素先验坐标系版本 : 0, now);
            (void)写入基础节点I64(宿主, 特征_场景体素先验可用状态(), 场景体素先验可用状态已读 ? 场景体素先验可用状态 : 0, now);
            (void)写入基础节点I64(宿主, 特征_视觉先验匹配状态(), 视觉先验匹配状态, now);
            (void)写入基础节点I64(宿主, 特征_视觉先验匹配数量(), std::max<I64>(0, 视觉先验匹配数量), now);
            (void)写入基础节点I64(宿主, 特征_视觉先验匹配评分(), std::clamp<I64>(视觉先验匹配评分, 0, 10000), now);
            (void)写入基础节点I64(宿主, 特征_视觉深度一致评分(), std::clamp<I64>(视觉深度一致评分, 0, 10000), now);
            (void)写入基础节点I64(宿主, 特征_视觉自由空间冲突候选数量(), std::max<I64>(0, 视觉自由空间冲突候选数量), now);
            (void)写入基础节点I64(宿主, 特征_视觉信息缺口数量(), std::max<I64>(0, 视觉信息缺口数量), now);
            (void)写入基础节点I64(宿主, 特征_视觉遮挡候选数量(), std::max<I64>(0, 视觉遮挡候选数量), now);
            (void)写入基础节点I64(宿主, 特征_视觉深度缺失数量(), std::max<I64>(0, 视觉深度缺失数量), now);
            (void)写入基础节点I64(宿主, 特征_视觉证据不足数量(), std::max<I64>(0, 视觉证据不足数量), now);
        ...
        (void)写入目标方法I64实际结果状态(
            ...
            环境.方法首节点,
            特征_视觉先验匹配评分(),
            std::clamp<I64>(视觉先验匹配评分, 0, 10000),
            实际输出场景,
            now);
        (void)写入目标方法I64实际结果状态(
            环境.方法首节点,
            ...
            "外设观察存在候选确认方案取得状态");
        {
            ...
            输出 << "外设观察材料识别归属结果"
                ...
                << " | 同一性评分=" << 同一性评分
                << " | 自我归属状态=" << 归属状态
                << " | 视觉先验字段已读=" << (视觉先验字段已读 ? 1 : 0)
                << " | 视觉先验匹配状态=" << 视觉先验匹配状态
                << " | 视觉先验匹配数量=" << 视觉先验匹配数量
                << " | 视觉先验匹配评分=" << 视觉先验匹配评分
                << " | 视觉深度一致评分=" << 视觉深度一致评分
                << " | 视觉自由空间冲突候选数量=" << 视觉自由空间冲突候选数量
                << " | 视觉信息缺口数量=" << 视觉信息缺口数量
                << " | 视觉遮挡候选数量=" << 视觉遮挡候选数量
                << " | 视觉深度缺失数量=" << 视觉深度缺失数量
                << " | 视觉证据不足数量=" << 视觉证据不足数量
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        const auto 跟踪共享外设输入 = 跟踪报告可选.has_value()
            ? std::optional<结构_共享关联外设材料输入>(
                构造共享关联外设材料输入_由观察报告(*跟踪报告可选, nullptr))
            : std::nullopt;
        ...
        auto 读取跟踪先验I64 = [&](const 语素入口节点类* 特征类型, I64& 输出值) noexcept {
            bool 已读 = 读取提交入口I64(
                输入参数场景,
                实际输出场景,
                目标宿主,
        ...
        I64 场景体素先验版本 = 0;
        const bool 场景体素先验版本已读 = 读取跟踪先验I64(
            特征_场景体素先验版本(),
            场景体素先验版本);
        I64 场景体素先验坐标系版本 = 0;
        const bool 场景体素先验坐标系版本已读 = 读取跟踪先验I64(
            特征_场景体素先验坐标系版本(),
            场景体素先验坐标系版本);
        I64 场景体素先验可用状态 = 0;
        const bool 场景体素先验可用状态已读 = 读取跟踪先验I64(
            特征_场景体素先验可用状态(),
            场景体素先验可用状态);
        I64 视觉先验匹配状态 = 视觉先验匹配状态_未读取;
        const bool 视觉先验匹配状态已读 = 读取跟踪先验I64(
            特征_视觉先验匹配状态(),
            视觉先验匹配状态);
        I64 视觉先验匹配数量 = 0;
        const bool 视觉先验匹配数量已读 = 读取跟踪先验I64(
            特征_视觉先验匹配数量(),
            视觉先验匹配数量);
        I64 视觉先验匹配评分 = 0;
        const bool 视觉先验匹配评分已读 = 读取跟踪先验I64(
            特征_视觉先验匹配评分(),
            视觉先验匹配评分);
        I64 视觉深度一致评分 = 0;
        const bool 视觉深度一致评分已读 = 读取跟踪先验I64(
            特征_视觉深度一致评分(),
            视觉深度一致评分);
        I64 视觉自由空间冲突候选数量 = 0;
        const bool 视觉自由空间冲突候选数量已读 = 读取跟踪先验I64(
            特征_视觉自由空间冲突候选数量(),
            视觉自由空间冲突候选数量);
        I64 视觉信息缺口数量 = 0;
        const bool 视觉信息缺口数量已读 = 读取跟踪先验I64(
            特征_视觉信息缺口数量(),
            视觉信息缺口数量);
        I64 视野外证据数量 = 0;
        const bool 视野外证据数量已读 = 读取跟踪先验I64(
            特征_视野外证据数量(),
            视野外证据数量);
        I64 视觉遮挡候选数量 = 0;
        const bool 视觉遮挡候选数量已读 = 读取跟踪先验I64(
            特征_视觉遮挡候选数量(),
            视觉遮挡候选数量);
        I64 视觉深度缺失数量 = 0;
        const bool 视觉深度缺失数量已读 = 读取跟踪先验I64(
            特征_视觉深度缺失数量(),
            视觉深度缺失数量);
        I64 视觉证据不足数量 = 0;
        const bool 视觉证据不足数量已读 = 读取跟踪先验I64(
            特征_视觉证据不足数量(),
            视觉证据不足数量);
        const bool 场景体素先验字段已读 =
            场景体素先验版本已读
            || 场景体素先验坐标系版本已读
            || 场景体素先验可用状态已读;
        const bool 视觉先验字段已读 =
            ...
            || 视觉深度缺失数量已读
            || 视觉证据不足数量已读;
        const bool 跟踪先验字段已读 = 场景体素先验字段已读 || 视觉先验字段已读;
        const bool 场景体素先验可用于跟踪 =
            场景体素先验版本已读
            && 场景体素先验版本 > 0
            && 场景体素先验坐标系版本已读
            && 场景体素先验坐标系版本 > 0
            && 场景体素先验可用状态已读
            && 场景体素先验可用状态 > 0;
        I64 跟踪视觉先验匹配状态 = 视觉先验匹配状态_未读取;
        if (视觉先验匹配状态已读 && 视觉先验匹配状态 != 视觉先验匹配状态_未读取) {
            跟踪视觉先验匹配状态 = 视觉先验匹配状态;
        } else if (视觉自由空间冲突候选数量已读 && 视觉自由空间冲突候选数量 > 0) {
            跟踪视觉先验匹配状态 = 视觉先验匹配状态_冲突;
        } else if ((视觉信息缺口数量已读 && 视觉信息缺口数量 > 0)
            || (视野外证据数量已读 && 视野外证据数量 > 0)
            || (视觉深度缺失数量已读 && 视觉深度缺失数量 > 0)
            || (视觉证据不足数量已读 && 视觉证据不足数量 > 0)) {
            跟踪视觉先验匹配状态 = 视觉先验匹配状态_证据不足;
        } else if ((视觉先验匹配数量已读 && 视觉先验匹配数量 > 0)
            || (视觉先验匹配评分已读 && 视觉先验匹配评分 > 0)) {
            跟踪视觉先验匹配状态 = 视觉先验匹配状态_已匹配;
        } else if (视觉先验字段已读) {
            跟踪视觉先验匹配状态 = 视觉先验匹配状态_无匹配;
        }
        const I64 跟踪先验预计范围状态 = !跟踪先验字段已读
            ? 跟踪先验预计范围状态_未读取
            : (场景体素先验可用于跟踪 && 指定存在跟踪预测区间有效(跟踪结果)
                ? 跟踪先验预计范围状态_已建立
                : 跟踪先验预计范围状态_条件不足);
        ...
        I64 跟踪丢失解释状态 = 跟踪丢失解释状态_未解释;
        if (跟踪结果.丢失状态 == 目标存在丢失状态_未丢失) {
            跟踪丢失解释状态 = 跟踪丢失解释状态_无丢失;
        } else if (跟踪结果.丢失状态 == 目标存在丢失状态_已丢失) {
            if (视野外证据数量已读 && 视野外证据数量 > 0) {
                跟踪丢失解释状态 = 跟踪丢失解释状态_视野外;
            } else if (视觉深度缺失数量已读 && 视觉深度缺失数量 > 0) {
                跟踪丢失解释状态 = 跟踪丢失解释状态_深度缺失;
            } else if (视觉遮挡候选数量已读 && 视觉遮挡候选数量 > 0) {
                跟踪丢失解释状态 = 跟踪丢失解释状态_遮挡;
            } else if (场景体素先验可用于跟踪
                && 视觉自由空间冲突候选数量已读
                && 视觉自由空间冲突候选数量 > 0) {
                跟踪丢失解释状态 = 跟踪丢失解释状态_自由空间冲突;
            } else if ((视觉信息缺口数量已读 && 视觉信息缺口数量 > 0)
                || (视觉证据不足数量已读 && 视觉证据不足数量 > 0)
                || !场景体素先验可用于跟踪) {
                跟踪丢失解释状态 = 跟踪丢失解释状态_证据不足;
            }
        } else if (跟踪先验字段已读) {
            跟踪丢失解释状态 = 跟踪丢失解释状态_证据不足;
        }
        ...
        auto 写跟踪先验证据 = [&](基础信息节点类* 宿主) noexcept {
            if (!宿主) return;
            写入共享关联外设材料输入摘要(宿主, 跟踪共享外设输入, now);
            (void)写入基础节点I64(宿主, 特征_场景体素先验版本(), 场景体素先验版本, now);
            (void)写入基础节点I64(宿主, 特征_场景体素先验坐标系版本(), 场景体素先验坐标系版本, now);
            (void)写入基础节点I64(宿主, 特征_场景体素先验可用状态(), 场景体素先验可用状态, now);
            (void)写入基础节点I64(宿主, 特征_视觉先验匹配状态(), 跟踪视觉先验匹配状态, now);
            (void)写入基础节点I64(宿主, 特征_视觉先验匹配数量(), std::max<I64>(0, 视觉先验匹配数量), now);
            (void)写入基础节点I64(宿主, 特征_视觉先验匹配评分(), std::clamp<I64>(视觉先验匹配评分, 0, 10000), now);
            (void)写入基础节点I64(宿主, 特征_视觉深度一致评分(), std::clamp<I64>(视觉深度一致评分, 0, 10000), now);
            (void)写入基础节点I64(宿主, 特征_视觉自由空间冲突候选数量(), std::max<I64>(0, 视觉自由空间冲突候选数量), now);
            ...
            (void)写入基础节点I64(宿主, 特征_视觉深度缺失数量(), std::max<I64>(0, 视觉深度缺失数量), now);
            (void)写入基础节点I64(宿主, 特征_视觉证据不足数量(), std::max<I64>(0, 视觉证据不足数量), now);
            (void)写入基础节点I64(宿主, 特征_跟踪先验预计范围状态(), 跟踪先验预计范围状态, now);
            (void)写入基础节点I64(宿主, 特征_跟踪丢失解释状态(), 跟踪丢失解释状态, now);
        };
        写跟踪结果(reinterpret_cast<基础信息节点类*>(环境.本轮运行虚拟存在));
        写跟踪结果(reinterpret_cast<基础信息节点类*>(实际输出场景));
        写跟踪结果(目标宿主);
        写跟踪结果(reinterpret_cast<基础信息节点类*>(目标存在));
        写跟踪先验证据(reinterpret_cast<基础信息节点类*>(环境.本轮运行虚拟存在));
        写跟踪先验证据(reinterpret_cast<基础信息节点类*>(实际输出场景));
        写跟踪先验证据(目标宿主);
        (void)写入目标方法I64实际结果状态(
            环境.方法首节点,
            环境.方法首节点,
            ...
            now);
        {
            ...
            输出 << "指定存在跟踪正式结果"
                ...
                << " | 跟踪先验字段已读=" << (跟踪先验字段已读 ? 1 : 0)
                << " | 场景体素先验可用于跟踪=" << (场景体素先验可用于跟踪 ? 1 : 0)
                << " | 场景体素先验版本=" << 场景体素先验版本
                << " | 场景体素先验坐标系版本=" << 场景体素先验坐标系版本
                << " | 场景体素先验可用状态=" << 场景体素先验可用状态
                << " | 跟踪先验预计范围状态=" << 跟踪先验预计范围状态
                << " | 跟踪丢失解释状态=" << 跟踪丢失解释状态
                << " | 跟踪视觉先验匹配状态=" << 跟踪视觉先验匹配状态
                << " | 视觉先验匹配数量=" << 视觉先验匹配数量
                << " | 视觉先验匹配评分=" << 视觉先验匹配评分
                << " | 视觉深度一致评分=" << 视觉深度一致评分
                << " | 视觉自由空间冲突候选数量=" << 视觉自由空间冲突候选数量
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        for (const auto& 项 : 方案.项集合) {
            ...
            auto* 节点 = reinterpret_cast<基础信息节点类*>(观察存在);
            if (!节点) continue;
            写入已确认观察存在节点原始事实(观察存在, 假设, 验证, &项.簇, 方案.报告ID, now);
            if (项.方案类型 == 外设观察存在候选确认方案_合并 && 项.目标已知存在) {
                (void)提交已确认存在轮廓组体素加工任务(
                    观察存在,
                    项.簇,
                    方案.报告ID,
                    now);
            }
            (void)写入观察候选C收束状态(节点, 项, now);
            ++已提交数量;
            原始事实写入状态 = 1;
            场景关联状态 = 1;
            已提交项集合.push_back({
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        I64 场景体素先验版本 = 0;
        bool 场景体素先验版本已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_场景体素先验版本(),
            场景体素先验版本);
        if (!场景体素先验版本已读 || 场景体素先验版本 <= 0) {
            场景体素先验版本已读 = 读取最新提交输入I64(
                特征_场景体素先验版本(),
                场景体素先验版本) || 场景体素先验版本已读;
        }

        I64 场景体素先验坐标系版本 = 0;
        bool 场景体素先验坐标系版本已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_场景体素先验坐标系版本(),
            场景体素先验坐标系版本);
        if (!场景体素先验坐标系版本已读 || 场景体素先验坐标系版本 <= 0) {
            场景体素先验坐标系版本已读 = 读取最新提交输入I64(
                特征_场景体素先验坐标系版本(),
                场景体素先验坐标系版本) || 场景体素先验坐标系版本已读;
        }

        I64 场景体素先验可用状态 = 0;
        bool 场景体素先验可用状态已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_场景体素先验可用状态(),
            场景体素先验可用状态);
        if (!场景体素先验可用状态已读 || 场景体素先验可用状态 <= 0) {
            场景体素先验可用状态已读 = 读取最新提交输入I64(
                特征_场景体素先验可用状态(),
                场景体素先验可用状态) || 场景体素先验可用状态已读;
        }

        I64 视觉先验匹配状态 = 视觉先验匹配状态_未读取;
        bool 视觉先验匹配状态已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉先验匹配状态(),
            视觉先验匹配状态);
        if (!视觉先验匹配状态已读 || 视觉先验匹配状态 == 视觉先验匹配状态_未读取) {
            视觉先验匹配状态已读 = 读取最新提交输入I64(
                特征_视觉先验匹配状态(),
                视觉先验匹配状态) || 视觉先验匹配状态已读;
        }

        I64 视觉先验匹配数量 = 0;
        bool 视觉先验匹配数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉先验匹配数量(),
            视觉先验匹配数量);
        if (!视觉先验匹配数量已读) {
            视觉先验匹配数量已读 = 读取最新提交输入I64(
                特征_视觉先验匹配数量(),
                视觉先验匹配数量);
        }

        I64 视觉先验匹配评分 = 0;
        bool 视觉先验匹配评分已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉先验匹配评分(),
            视觉先验匹配评分);
        if (!视觉先验匹配评分已读) {
            视觉先验匹配评分已读 = 读取最新提交输入I64(
                特征_视觉先验匹配评分(),
                视觉先验匹配评分);
        }

        I64 视觉深度一致评分 = 0;
        bool 视觉深度一致评分已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉深度一致评分(),
            视觉深度一致评分);
        if (!视觉深度一致评分已读) {
            视觉深度一致评分已读 = 读取最新提交输入I64(
                特征_视觉深度一致评分(),
                视觉深度一致评分);
        }

        I64 视觉自由空间冲突候选数量 = 0;
        bool 视觉自由空间冲突候选数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉自由空间冲突候选数量(),
            视觉自由空间冲突候选数量);
        if (!视觉自由空间冲突候选数量已读) {
            视觉自由空间冲突候选数量已读 = 读取最新提交输入I64(
                特征_视觉自由空间冲突候选数量(),
                视觉自由空间冲突候选数量);
        }

        I64 视觉信息缺口数量 = 0;
        bool 视觉信息缺口数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉信息缺口数量(),
            视觉信息缺口数量);
        if (!视觉信息缺口数量已读) {
            视觉信息缺口数量已读 = 读取最新提交输入I64(
                特征_视觉信息缺口数量(),
                视觉信息缺口数量);
        }

        I64 视觉遮挡候选数量 = 0;
        bool 视觉遮挡候选数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉遮挡候选数量(),
            视觉遮挡候选数量);
        if (!视觉遮挡候选数量已读) {
            视觉遮挡候选数量已读 = 读取最新提交输入I64(
                特征_视觉遮挡候选数量(),
                视觉遮挡候选数量);
        }

        I64 视觉深度缺失数量 = 0;
        bool 视觉深度缺失数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉深度缺失数量(),
            视觉深度缺失数量);
        if (!视觉深度缺失数量已读) {
            视觉深度缺失数量已读 = 读取最新提交输入I64(
                特征_视觉深度缺失数量(),
                视觉深度缺失数量);
        }

        I64 视觉证据不足数量 = 0;
        bool 视觉证据不足数量已读 = 读取提交入口I64(
            输入参数场景,
            实际输出场景,
            目标宿主,
            特征_视觉证据不足数量(),
        ...
        const I64 来源报告时间戳毫秒 = 对应来源报告可选 ? 对应来源报告可选->时间戳毫秒 : 0;
        const I64 当前毫秒 = static_cast<I64>(now / 1000);
        I64 来源材料过期状态 = 外设提交包过期状态_未知;
        I64 来源新鲜度失败原因 = 新鲜度失败原因_无;
        if (对应来源报告可选.has_value()) {
            if (来源报告时间戳毫秒 <= 0) {
                来源新鲜度失败原因 |= 新鲜度失败原因_缺采集时间;
            } else if (当前毫秒 > 0
                && 最大允许当前观察年龄微秒 > 0
                && 当前毫秒 - 来源报告时间戳毫秒 > 最大允许当前观察年龄微秒 / 1000) {
                来源新鲜度失败原因 |= 新鲜度失败原因_观察过期;
            }
            来源材料过期状态 =
                (来源新鲜度失败原因 & 新鲜度失败原因_观察过期) != 0
                    ? 外设提交包过期状态_已过期
                    : 外设提交包过期状态_未过期;
        }

        const bool 观察域结果包先验字段已读 =
            场景体素先验版本已读
            || 场景体素先验坐标系版本已读
            || 场景体素先验可用状态已读
            || 视觉先验匹配状态已读
            ...
            || 视觉深度缺失数量已读
            || 视觉证据不足数量已读;
        I64 先验版本闸门缺口原因掩码 = 先验版本闸门缺口_无;
        if (!观察域结果包先验字段已读) 先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_缺观察域结果包;
        if (!场景体素先验版本已读 || 场景体素先验版本 <= 0) 先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_缺先验版本;
        if (!场景体素先验坐标系版本已读 || 场景体素先验坐标系版本 <= 0) 先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_缺坐标系版本;
        if (!场景体素先验可用状态已读 || 场景体素先验可用状态 <= 0) 先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_先验不可用;
        if (对应来源报告可选.has_value() && 来源报告时间戳毫秒 <= 0) 先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_来源材料缺时间;
        if ((来源新鲜度失败原因 & 新鲜度失败原因_观察过期) != 0) 先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_来源材料过期;
        if (对应来源报告可选.has_value()
            && 对应来源质量判定.坐标系一致性状态 != 枚举_外设坐标系一致性状态::一致) {
            先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_来源坐标系不一致;
        }
        if (视觉信息缺口数量已读 && 视觉信息缺口数量 > 0) 先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_视觉信息缺口;
        if (视觉证据不足数量已读 && 视觉证据不足数量 > 0) 先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_视觉证据不足;
        if (视觉自由空间冲突候选数量已读 && 视觉自由空间冲突候选数量 > 0) 先验版本闸门缺口原因掩码 |= 先验版本闸门缺口_自由空间冲突;

        I64 先验版本可接受状态 = 先验版本可接受状态_条件不足;
        if (先验版本闸门缺口原因掩码 == 先验版本闸门缺口_无) {
            先验版本可接受状态 = 先验版本可接受状态_可接受;
        } else if ((先验版本闸门缺口原因掩码 & 先验版本闸门缺口_来源材料过期) != 0) {
            先验版本可接受状态 = 先验版本可接受状态_来源材料过期;
        } else if ((先验版本闸门缺口原因掩码
                & (先验版本闸门缺口_视觉信息缺口
                    | 先验版本闸门缺口_视觉证据不足
                    | 先验版本闸门缺口_自由空间冲突)) != 0) {
            先验版本可接受状态 = 先验版本可接受状态_视觉证据不足;
        }
        const bool 视觉先验版本闸门通过 =
            先验版本可接受状态 == 先验版本可接受状态_可接受;
        {
            std::ostringstream 输出;
        ...
        auto 重算对应事实提交判定 = [&]() noexcept {
            ...
            缺口可解释状态 = 可写对应事实
                || 先验版本闸门缺口原因掩码 != 0
                || (计数可读 && (冲突数量已读 || 证据不足数量已读))
                    ? 1
                    : 0;
            映射缺口原因掩码 = 0;
            if (!识别正式结果可读) 映射缺口原因掩码 |= 映射缺口原因_识别正式结果不可读;
            if (!计数可读) 映射缺口原因掩码 |= 映射缺口原因_计数不可读;
            if (!提交确认链可读) 映射缺口原因掩码 |= 映射缺口原因_提交确认链不可读;
            if (未稳定对应单位数量 > 0) 映射缺口原因掩码 |= 映射缺口原因_未稳定对应单位;
            if (多重冲突数量 > 0) 映射缺口原因掩码 |= 映射缺口原因_CE多重对应冲突;
            if (证据不足数量已读 && 证据不足数量 > 0) 映射缺口原因掩码 |= 映射缺口原因_证据不足;
            if (!对应来源可交付观察方法材料) 映射缺口原因掩码 |= 映射缺口原因_来源材料不可交付;
            if (!视觉先验版本闸门通过) 映射缺口原因掩码 |= 映射缺口原因_视觉先验版本闸门不通过;
            提交状态 = 可写对应事实
                ? (对应闭合状态 > 0
                    ? 可观测单位存在对应事实提交状态_已提交
        ...
        重算对应事实提交判定();
        auto 写先验版本闸门摘要 = [&](基础信息节点类* 宿主) noexcept {
            if (!宿主) return;
            (void)写入基础节点I64(宿主, 特征_场景体素先验版本(), 场景体素先验版本, now);
            (void)写入基础节点I64(宿主, 特征_场景体素先验坐标系版本(), 场景体素先验坐标系版本, now);
            (void)写入基础节点I64(宿主, 特征_场景体素先验可用状态(), 场景体素先验可用状态, now);
            ...
            (void)写入基础节点I64(宿主, 特征_视觉深度缺失数量(), std::max<I64>(0, 视觉深度缺失数量), now);
            (void)写入基础节点I64(宿主, 特征_视觉证据不足数量(), std::max<I64>(0, 视觉证据不足数量), now);
            (void)写入基础节点I64(宿主, 特征_先验版本可接受状态(), 先验版本可接受状态, now);
            (void)写入基础节点I64(宿主, 特征_先验版本闸门缺口原因掩码(), 先验版本闸门缺口原因掩码, now);
            (void)写入基础节点I64(宿主, 特征_来源报告时间戳毫秒(), 来源报告时间戳毫秒, now);
            (void)写入基础节点I64(宿主, 特征_当前观察新鲜度状态(),
                来源材料过期状态 == 外设提交包过期状态_未过期
                    ? 观察事实状态_新鲜
                    : (来源材料过期状态 == 外设提交包过期状态_已过期
                        ? 观察事实状态_过期
                        : 观察事实状态_未成立),
                now);
            (void)写入基础节点I64(宿主, 特征_新鲜度失败原因(), 来源新鲜度失败原因, now);
        };
        if (缺报告失败快退) {
        ...
        const bool 允许创建对应事实节点 =
            !缺报告失败快退
            && 视觉先验版本闸门通过;
        auto* 对应事实 = !允许创建对应事实节点
            ? nullptr
        ...
        enum class 枚举_稳定子集桥失败原因 : std::uint8_t {
            无 = 0,
            缺事实宿主 = 1,
            缺对应事实 = 2,
            缺映射表 = 3,
        ...
        struct 结构_稳定子集扫描目标上下文桥结果 {
            ...
            枚举_稳定子集桥失败原因 首个失败原因 = 枚举_稳定子集桥失败原因::无;
            枚举_目标观察约束可用性 首个失败可用性状态 = 枚举_目标观察约束可用性::未定义;
        };
        auto 记录首个稳定子集桥失败 = [](
            结构_稳定子集扫描目标上下文桥结果& 桥,
            const 枚举_稳定子集桥失败原因 原因,
            const 枚举_目标观察约束可用性 可用性状态 = 枚举_目标观察约束可用性::未定义) noexcept {
            if (桥.首个失败原因 != 枚举_稳定子集桥失败原因::无) {
                return;
            }
            桥.首个失败原因 = 原因;
            桥.首个失败可用性状态 = 可用性状态;
        };
        auto 稳定子集桥失败说明文本 = [&](const 结构_稳定子集扫描目标上下文桥结果& 桥) -> std::string {
            switch (桥.首个失败原因) {
            case 枚举_稳定子集桥失败原因::缺事实宿主: return "缺事实宿主";
            case 枚举_稳定子集桥失败原因::缺对应事实: return "缺当前观察范围可观测单位存在对应事实";
            case 枚举_稳定子集桥失败原因::缺映射表: return "缺可观测单位到存在映射表";
            case 枚举_稳定子集桥失败原因::缺正式逐簇报告:
                return 正式逐簇报告缺口说明.empty()
                    ? std::string("缺正式逐簇报告")
                    : 正式逐簇报告缺口说明;
            case 枚举_稳定子集桥失败原因::缺可交付观察方法材料:
                return 正式逐簇报告缺口说明.empty()
                    ? std::string("缺可交付观察方法材料")
                    : 正式逐簇报告缺口说明;
            case 枚举_稳定子集桥失败原因::缺稳定对应存在: return "缺稳定对应存在";
            case 枚举_稳定子集桥失败原因::缺稳定对应存在计数: return "缺稳定对应存在计数";
            case 枚举_稳定子集桥失败原因::扫描可启动状态未形成: return "稳定子集扫描可启动状态未形成";
            case 枚举_稳定子集桥失败原因::未取得已确认观察存在: return "稳定子集项未取得正式已确认观察存在";
            case 枚举_稳定子集桥失败原因::目标观察约束不可用:
                return 桥.首个失败可用性状态 == 枚举_目标观察约束可用性::未定义
                    ? std::string("目标观察约束写入后不可用")
                    : 目标观察约束可用性文本(桥.首个失败可用性状态);
            case 枚举_稳定子集桥失败原因::无:
            default:
                return {};
            }
        ...
        auto 构造稳定子集目标约束 = [&](const 结构_外设观察报告队列项& 报告,
            ...
            const 语素入口节点类* 目标特征类型,
            I64 目标特征当前值,
            const char* 约束用途) noexcept -> 结构_目标观察约束特征组 {
            结构_目标观察约束特征组 约束{};
            if (!目标存在 || !目标特征类型) {
                return 约束;
            }
        ...
        auto 写入稳定子集桥 = [&]() noexcept {
            ...
            if (!事实宿主) {
                记录首个稳定子集桥失败(桥, 枚举_稳定子集桥失败原因::缺事实宿主);
                return 桥;
            }
            if (!对应事实) {
                记录首个稳定子集桥失败(桥, 枚举_稳定子集桥失败原因::缺对应事实);
                return 桥;
            }
            if (!映射表) {
                记录首个稳定子集桥失败(桥, 枚举_稳定子集桥失败原因::缺映射表);
                return 桥;
            }
            if (!报告) {
                记录首个稳定子集桥失败(桥, 枚举_稳定子集桥失败原因::缺正式逐簇报告);
                return 桥;
            }
            if (!对应来源可交付观察方法材料) {
                记录首个稳定子集桥失败(桥, 枚举_稳定子集桥失败原因::缺可交付观察方法材料);
                return 桥;
            }
            if (稳定对应存在数量 <= 0) {
                记录首个稳定子集桥失败(
                    桥,
                    已验证数量已读
                        ? 枚举_稳定子集桥失败原因::缺稳定对应存在
                        : 枚举_稳定子集桥失败原因::缺稳定对应存在计数);
                return 桥;
            }
            if (扫描可启动状态 <= 0) {
                记录首个稳定子集桥失败(桥, 枚举_稳定子集桥失败原因::扫描可启动状态未形成);
                return 桥;
            }
            结构_外设观察存在确认方案 临时方案{};
            ...
            for (const auto& 项 : 方案.项集合) {
                ...
                auto* 观察节点 = reinterpret_cast<基础信息节点类*>(观察存在);
                if (!观察节点) {
                    记录首个稳定子集桥失败(桥, 枚举_稳定子集桥失败原因::未取得已确认观察存在);
                    continue;
                }
        ...
        auto 写对应事实摘要 = [&](基础信息节点类* 宿主) noexcept {
            ...
            写入P11结构化缺口摘要(宿主, 映射缺口原因掩码, 先验版本闸门缺口原因掩码, now);
            (void)写入基础节点I64(宿主, 特征_当前观察范围有效可观测单位计数事实取得状态(), 计数事实取得状态, now);
            (void)写入基础节点I64(宿主, 特征_当前观察范围可观测单位存在稳定对应事实取得状态(), 稳定对应事实取得状态, now);
            (void)写入基础节点I64(宿主, 特征_稳定对应存在数量明确状态(), 稳定数量明确状态, now);
            (void)写入基础节点I64(宿主, 特征_当前观察范围可观测单位存在对应闭合状态(), 对应闭合状态, now);
        ...
        const auto 阶段_输出运行结束 = 结构体_时间戳::当前_微秒();
        {
            ...
            输出 << "当前观察范围可观测单位存在对应事实提交"
                ...
                << " | 可交付观察方法材料=" << (对应来源可交付观察方法材料 ? 1 : 0)
                << " | 正式逐簇报告缺口说明=" << 正式逐簇报告缺口说明
                << " | 稳定子集桥失败说明=" << 稳定子集桥失败说明文本(稳定子集桥)
                << " | 缺报告失败快退=" << (缺报告失败快退 ? 1 : 0)
                << " | 允许创建对应事实节点=" << (允许创建对应事实节点 ? 1 : 0)
                << " | 对应事实节点存在=" << (对应事实 ? 1 : 0)
                << " | 映射表节点存在=" << (映射表 ? 1 : 0)
                << " | 动作动态=" << 基础节点日志文本(reinterpret_cast<基础信息节点类*>(动态))
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        if (允许提交) {
            ...
            if (auto* 子节点 = reinterpret_cast<基础信息节点类*>(子存在)) {
                ...
                if (子体素结果.成功) {
                    ...
                    I64 体素观察证据ID = 0;
                    I64 体素基准版本 = 0;
                    (void)读取基础节点I64(目标节点, 特征_体素观察证据ID(), 体素观察证据ID);
                    (void)读取基础节点I64(目标节点, 特征_体素加工基准体素版本(), 体素基准版本);
                    if (体素观察证据ID <= 0 && 上下文.外设观察报告ID > 0) {
                        const I64 簇或候选ID = 上下文.外设观察像素簇ID > 0
                            ? 上下文.外设观察像素簇ID
                            : 上下文.来源候选编号;
                        if (簇或候选ID > 0
                            && 上下文.外设观察报告ID <= 9000000000000LL
                            && 簇或候选ID <= 999999LL) {
                            体素观察证据ID = 上下文.外设观察报告ID * 1000000LL + 簇或候选ID;
                        }
                    }
                    子候选映射结果 = 写入体素子候选映射与颜色事实(
                        子存在,
                        上下文.目标存在,
                        体素观察证据ID,
                        体素基准版本,
                        now);
                    子候选映射状态 = 子候选映射结果.映射状态;
                    子候选ID = 子候选映射结果.子候选ID;
                    局部子体素候选ID = 子候选映射结果.局部子体素候选ID;
                    (void)读取基础节点I64(子节点, 特征_体素子平均颜色事实状态(), 子平均颜色事实状态);
                    原始事实写入状态 = 1;
                    内部世界关联状态 = 1;
                    子体素模型写入状态 = 1;
                    父子坐标映射状态 = 1;
        ...
        auto 写提交摘要 = [&](基础信息节点类* 宿主) noexcept {
            ...
            (void)写入基础节点I64(宿主, 特征_体素子候选映射状态(), 子候选映射状态, now);
            (void)写入基础节点I64(宿主, 特征_体素子候选ID(), 子候选ID, now);
            (void)写入基础节点I64(宿主, 特征_体素局部子体素候选ID(), 局部子体素候选ID, now);
            (void)写入基础节点I64(宿主, 特征_体素子平均颜色事实状态(), 子平均颜色事实状态, now);
            if (动态) {
                (void)写入基础节点指针(宿主, 特征_动作动态(), 动态, now);
            }
            if (失败原因) {
            ...
            now);
        {
            ...
            输出 << "提交_确认内部世界子存在事实"
                ...
                << " | 子体素模型写入状态=" << 子体素模型写入状态
                << " | 子体素边长=" << 子体素结果.局部体素边长
                << " | 子体素占据数量=" << 子体素结果.占据体素数量
                << " | 父子坐标映射状态=" << 父子坐标映射状态
                << " | 体素子候选映射状态=" << 子候选映射状态
                << " | 体素子候选ID=" << 子候选ID
                << " | 体素局部子体素候选ID=" << 局部子体素候选ID
                << " | 体素子平均颜色事实状态=" << 子平均颜色事实状态
                << " | 体素可映射子候选数量=" << 子候选映射结果.可映射候选数量
                << " | 写入二次特征数量=" << 二次特征写入数量
                << " | 不写基础风险明确=1"
                << " | 不结算安全值=1"
                << " | 动作动态=" << 基础节点日志文本(reinterpret_cast<基础信息节点类*>(动态))
        ...
        场景节点类* 输出结果场景) noexcept
    {
        ...
        if (!目标宿主) {
            结果.成功 = false;
            结果.失败原因 = 值_执行缺口_当前方法条件不满足();
            结果.消息 = "观察条件不足:缺当前观察场景参数";
        }
        结构_被动识别外设观察材料结果 被动识别结果{};
        存在节点类* 被动识别存在 = nullptr;
        if (目标宿主) {
            被动识别存在 = 被动识别外设观察材料_内部治理(
                输入参数场景,
                目标宿主,
                实际输出场景,
                &被动识别结果,
        ...
        const auto 共享外设输入 = 被动识别结果.报告ID > 0
            ? 读取共享关联外设材料输入_按报告ID(
                static_cast<std::uint64_t>(被动识别结果.报告ID),
                nullptr)
            : std::nullopt;
        const bool 被动识别可进入观察写入 =
            被动识别结果满足观察写入收束闸门(被动识别结果);
        auto* 动态 = 写入双目相机I64事实与动态(
            环境.方法首节点,
            实际输出场景,
            目标宿主,
            nullptr,
            特征_观察存在发现状态(),
            被动识别可进入观察写入 ? 观察存在发现状态_已发现 : 0,
            被动识别可进入观察写入,
            输入参数场景,
            实际输出场景,
            环境.本轮运行虚拟存在,
            now);
        auto 观察治理结果 = 写入观察识别归属结果(
            目标宿主,
            被动识别结果,
            动态,
            now);
        ...
        写入观察内部治理记录(
            ...
            动态,
            now);
        auto 写结果 = [&](基础信息节点类* 宿主, const bool 允许P12主模型写入) noexcept {
            写入双目相机通用结果(宿主, 成功, nullptr, 目标宿主, 动态, 结果.失败原因, now);
            写入被动识别外设观察材料摘要(宿主, 被动识别结果, now, 允许P12主模型写入);
            写入共享关联外设材料输入摘要(宿主, 共享外设输入, now);
            if (!宿主) return;
            (void)写入基础节点指针(宿主, 特征_当前观察场景(), 目标宿主, now);
            (void)写入基础节点I64(宿主, 特征_观察存在发现状态(), 成功 ? 观察存在发现状态_已发现 : 观察存在发现状态_证据不足, now);
            (void)写入基础节点I64(宿主, 特征_存在当前特征状态(), 成功 ? 存在当前特征状态_已更新 : 存在当前特征状态_证据不足, now);
            (void)写入基础节点I64(宿主, 特征_观察内部治理记录状态(), 观察治理结果.记录状态, now);
            (void)写入基础节点I64(宿主, 特征_观察新建存在数量(), 观察治理结果.新建存在数量, now);
            (void)写入基础节点I64(宿主, 特征_观察更新已有存在数量(), 观察治理结果.更新已有存在数量, now);
            (void)写入基础节点I64(宿主, 特征_观察写入特征数量(), 观察治理结果.写入特征数量, now);
            (void)写入基础节点I64(宿主, 特征_观察治理处理项数量(), 观察治理结果.处理项数量, now);
            (void)写入基础节点I64(宿主, 特征_观察治理写入失败数量(), 观察治理结果.写入失败数量, now);
        };
        写结果(reinterpret_cast<基础信息节点类*>(环境.本轮运行虚拟存在), false);
        写结果(reinterpret_cast<基础信息节点类*>(实际输出场景), true);
        写结果(目标宿主, false);
            ...
            输出运行);
        {
            std::ostringstream 输出;
            输出 << "观察本能闭环"
                << " | 主动动作=自我_观察单个空间候选并组合存在假设"
                << " | 当前观察场景=" << 基础节点日志文本(目标宿主)
                << " | 已运行=" << (被动识别结果.已运行 ? 1 : 0)
                << " | 报告存在=" << (被动识别结果.来源报告存在 ? 1 : 0)
                << " | 报告ID=" << 被动识别结果.报告ID
                << " | 材料可进入识别=" << (被动识别结果.材料可进入识别 ? 1 : 0)
                << " | 上游验证状态=" << 被动识别结果.上游验证状态
                << " | 同一性状态=" << 被动识别结果.同一性状态
                << " | 归属状态=" << 被动识别结果.归属状态
                << " | 返回已有存在=" << (被动识别存在 ? 被动识别存在->获取主键() : std::string{})
                << " | 观察新建存在数量=" << 观察治理结果.新建存在数量
                << " | 观察更新已有存在数量=" << 观察治理结果.更新已有存在数量
                << " | 观察写入特征数量=" << 观察治理结果.写入特征数量
                << " | 观察治理处理项数量=" << 观察治理结果.处理项数量
                << " | 观察治理写入失败数量=" << 观察治理结果.写入失败数量
                << " | 被动治理动作动态=" << (观察治理结果.被动动作动态 ? 观察治理结果.被动动作动态->获取主键() : std::string("空"))
                << " | 中间层近组取数=1"
                << " | 只取中间层近组最新材料=1"
                << " | 不从输入接收中间层数据=1"
                << " | 忽略输入报告ID=1"
