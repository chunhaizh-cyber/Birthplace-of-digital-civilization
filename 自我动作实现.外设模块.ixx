...
namespace {
    ...
    {
        if (!宿主) return;
        (void)写入基础节点I64(宿主, 特征_自我_场景绝对坐标明确状态(), 自我场景参照明确状态_已明确, now);
        (void)写入基础节点I64(宿主, 特征_自我_场景绝对坐标X(), x, now);
        (void)写入基础节点I64(宿主, 特征_自我_场景绝对坐标Y(), y, now);
        (void)写入基础节点I64(宿主, 特征_自我_场景绝对坐标Z(), z, now);
    }
