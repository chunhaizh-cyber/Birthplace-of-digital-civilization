...
inline constexpr std::int64_t 本能方法结果_任务筹办已激活学习任务 = -26002;
inline constexpr std::int64_t 本能方法结果_任务执行一步已建立方法头待重入 = -26003;
inline constexpr std::int64_t 本能方法结果_任务执行一步已激活学习任务 = -26004;
inline constexpr std::int64_t 本能方法结果_学习任务已建立任务头待重入 = -26005;
inline constexpr std::int64_t 本能方法结果_任务缺条件需自我线程 = -26006;
inline constexpr std::int64_t 本能方法结果_任务缺方法需任务管理任务 = -26007;
