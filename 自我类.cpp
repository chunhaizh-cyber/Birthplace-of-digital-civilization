...
void 自我类::初始化常用抽象特征_(const std::string& 调用点) noexcept
{
    ...
    const 词性节点类* 任务特征类型集[] = {
        ...
        自我特征定义类::类型_任务管理_学习承接类型(),
        自我特征定义类::类型_任务管理_学习反馈消费策略(),
        ...
        自我特征定义类::类型_任务管理_任务挂接方式(),
        自我特征定义类::类型_任务管理_学习目标类型(),
        自我特征定义类::类型_任务管理_学习需求类型(),
        自我特征定义类::类型_任务管理_学习动作类型(),
        自我特征定义类::类型_任务管理_学习原函数类型(),
        自我特征定义类::类型_任务管理_学习程序决策(),
