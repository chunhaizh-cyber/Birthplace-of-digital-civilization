...
struct 结构_控制面板快照 {
    ...
    std::size_t 需求树活动执行需求数 = 0;
    std::size_t 需求树活动执行需求未任务化数 = 0;
    std::string 需求树首个未任务化执行需求主键{};
    std::string 需求树首个未任务化执行需求父主键{};
    std::string 需求树首个未任务化执行需求目标主体主键{};
    std::string 需求树首个未任务化执行需求目标特征主键{};
    ...
    std::string 任务管理界面线程最近后台worker原因{};
    std::string 任务管理工作线程池最近参数保存结果{};
    std::string 任务管理工作线程池最近参数错误{};
    std::string 任务管理工作线程池最近参数应用结果{};
