...
namespace {
    ...
    std::string 私有_需求树SQL建表脚本()
    {
        ...
        SQL << "SET NOCOUNT ON;\n"
            ...
            << "IF OBJECT_ID(N'[鱼巢].[当前需求面板节点]', N'V') IS NOT NULL DROP VIEW [鱼巢].[当前需求面板节点];\n"
            << "IF OBJECT_ID(N'[鱼巢].[当前需求树节点]', N'V') IS NOT NULL DROP VIEW [鱼巢].[当前需求树节点];\n"
            << "IF OBJECT_ID(N'[鱼巢].[当前需求主信息]', N'V') IS NOT NULL DROP VIEW [鱼巢].[当前需求主信息];\n"
            << "IF OBJECT_ID(N'[鱼巢].[需求主信息]', N'U') IS NOT NULL DROP TABLE [鱼巢].[需求主信息];\n"
            << "IF OBJECT_ID(N'[鱼巢].[需求树节点]', N'U') IS NOT NULL DROP TABLE [鱼巢].[需求树节点];\n"
            << "IF OBJECT_ID(N'[鱼巢].[需求树快照]', N'U') IS NOT NULL DROP TABLE [鱼巢].[需求树快照];\n"
